...
function _get_component_from_parsed_url_array( $url_parts, $component = -1 ) {
	...
	$key = app_translate_php_url_constant_to_key( $component );
 ...
 */
function app_translate_php_url_constant_to_key( $constant ) {
	$translation = array(
