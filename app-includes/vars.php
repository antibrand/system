 ...
 * @since  1.0.0
 * @param  mixed $classes
 * @return mixed Returns the filtered classes. String back end, array front end.
 */
function app_agent_body_class( $classes ) {
	...
	if ( is_admin() ) {
		...
		if ( $is_lynx ) {
			...
			if ( preg_match( '/MSIE ([0-9]+)([a-zA-Z0-9.]+)/', $_SERVER['HTTP_USER_AGENT'], $browser_version ) ) {
				$classes = 'browser-ie' . $browser_version[1];
			}
		...
		// Space between browser class and OS class.
		$classes .= ' ';
...
add_filter( 'admin_body_class', 'app_agent_body_class' );
add_filter( 'body_class', 'app_agent_body_class' );
