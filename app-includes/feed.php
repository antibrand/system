 ...
 *
 * Text is defined as containing no markup,
...
function fetch_feed( $url ) {
	if ( ! class_exists( 'SimplePie', false ) ) {
		require_once( ABSPATH . APP_INC . '/classes/includes/class-simplepie.php' );
	}

	require_once( ABSPATH . APP_INC . '/classes/includes/class-app-feed-cache.php' );
	require_once( ABSPATH . APP_INC . '/classes/includes/class-app-feed-cache-transient.php' );
	require_once( ABSPATH . APP_INC . '/classes/includes/class-app-simplepie-file.php' );
	require_once( ABSPATH . APP_INC . '/classes/includes/class-app-simplepie-sanitize-kses.php' );
