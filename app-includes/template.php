 ...
 *
 * Searches in the STYLESHEETPATH before TEMPLATEPATH and app-includes/theme-compat
...
function locate_template( $template_names, $load = false, $require_once = true ) {
	...
	foreach ( (array) $template_names as $template_name ) {
		...
		} elseif ( file_exists( APP_VIEWS_DIR . '/' . $template_name ) ) {
			$located = APP_VIEWS_DIR . '/' . $template_name;
			break;
		}
	}
...
/**
 * Require the template file with the environment.
 *
...
function load_template( $_template_file, $require_once = true ) {
	global $posts, $post, $wp_did_header, $wp_query, $wp_rewrite, $wpdb, $app_version, $wp, $id, $comment, $user_ID;
