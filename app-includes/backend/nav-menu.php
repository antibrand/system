...
function wp_nav_menu_item_link_meta_box() {
	...
	<div class="customlinkdiv" id="customlinkdiv">
		...
		<p id="menu-item-url-wrap" class="app-clearfix">
		...
		<p id="menu-item-name-wrap" class="app-clearfix">
		...
		<p class="button-controls app-clearfix">
	...
	<div id="posttype-<?php echo $post_type_name; ?>" class="posttypediv">
		...
		?>">
			<ul id="<?php echo $post_type_name; ?>checklist-most-recent" class="categorychecklist form-no-clear">
				 ...
				 * @since Previous 4.9.0 Added the `$recent_args` parameter.
				 *
		...
		?>">
			...
			<ul id="<?php echo $post_type_name; ?>checklist" data-wp-lists="list:<?php echo $post_type_name?>" class="categorychecklist form-no-clear">
				 ...
				 * @since Previous 4.6.0 Converted the `$post_type` parameter to accept a WP_Post_Type object.
				 *
				 * @see WP_Query::query()
				 *
...
function wp_get_nav_menu_to_edit( $menu_id = 0 ) {
	...
	if ( is_nav_menu( $menu ) ) {
		 ...
		 */
		$walker_class_name = apply_filters( 'wp_edit_nav_menu_walker', 'AppNamespace\Backend\Walker_Nav_Menu_Edit', $menu_id );
...
function wp_nav_menu_update_menu_items ( $nav_menu_selected_id, $nav_menu_selected_title ) {
	...
	/** This action is documented in APP_INC_PATH . '/backend/nav-menu.php */
