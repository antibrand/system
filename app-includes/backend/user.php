...
function help_export_personal_data_overview() {
	...
	$html = require_once( APP_VIEWS_PATH . 'backend/help/export-personal-data-overview.php' );
...
function help_export_personal_data_usage() {
	...
	$html = require_once( APP_VIEWS_PATH . 'backend/help/export-personal-data-usage.php' );
...
function help_export_personal_data_download() {
	...
	$html = require_once( APP_VIEWS_PATH . 'backend/help/export-personal-data-download.php' );
...
function help_remove_personal_data_overview() {
	...
	$html = require_once( APP_VIEWS_PATH . 'backend/help/remove-personal-data-overview.php' );
