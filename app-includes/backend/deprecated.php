 ...
 * @since 1.5.0
 * @deprecated 2.9.0
 * @uses APP_VIEWS_PATH Full filesystem path to the APP_VIEWS_DIR directory.
 *
 * @param string $file Filesystem path relative to the APP_VIEWS_DIR directory.
 ...
 * @see wp_dashboard_quick_draft()
 */
function wp_dashboard_quick_draft_output() {
	_deprecated_function( __FUNCTION__, '3.2.0', 'wp_dashboard_quick_draft()' );
...
function wp_tiny_mce( $teeny = false, $settings = false ) {
	...
	if ( ! class_exists( '_WP_Editors', false ) )
		require_once( APP_INC_PATH . '/classes/includes/class-app-editor.php' );
...
function add_contextual_help( $screen, $help ) {
	...
	AppNamespace\Backend\Screen::add_old_compat_help( $screen, $help );
}
...
function get_screen_icon() {
	_deprecated_function( __FUNCTION__, '3.8.0' );
	return '<!-- Screen icons are no longer used. -->';
}
