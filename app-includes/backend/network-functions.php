...
function wpmu_delete_blog( $blog_id, $drop = false ) {
	...
	if ( $drop ) {
		...
		// This action is documented in app-includes/network-blogs.php.
 ...
 * @return mixed Returns the markup of the field,
 */
 ...
 *
 * @since  Previous 3.0.0
 * @return mixed Returns the markup of the fields.
 */
 ...
 * @since  Previous 3.1.0
 * @access private
 * @return mixed Returns the script markup.
 */
...
function confirm_delete_users( $users ) {
				...
				foreach ( (array) $blogs as $key => $details ) {
					...
					if ( is_array( $blog_users ) && ! empty( $blog_users ) ) {
						...
						<ul style="list-style:none;">
							<li>
								<?php printf( __( 'Site: %s' ), $user_site ); ?>
							</li>
	...
	<?php else : ?>
		...
		<p><?php submit_button( __( 'Confirm Deletion' ), 'primary' );	?></p>
 ...
 * @return mixed Returns the markup of the script.
 */
 ...
 * }
 * @return mixed Returns the markup of the interface.
 */
