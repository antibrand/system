...
function _unzip_file_pclzip($file, $to, $needed_dirs = array()) {
	...
	/**
	 * The PclZip class is in the autoloader.
	 * Leaving this require here until testing is completed.
	 *
 ...
 *
 * The return value can be overridden by defining the `FS_METHOD` constant in the configuration file,
...
function wp_privacy_generate_personal_data_export_file( $request_id ) {
	...
	if ( ! file_exists( $index_pathname ) ) {
		...
		fwrite( $file, '<!-- Nothing to display. -->' );
		fclose( $file );
	}
