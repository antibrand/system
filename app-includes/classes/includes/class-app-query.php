...
class WP_Query {
	 ...
	 *
	 * The query flags are what page info the application was able to figure out.
	 *
	 * @since 2.0.0
	 */
	...
	public function get_posts() {
		 ...
		 *
		 * Return a non-null value to bypass the default post queries.
		 *
		...
		if ( !empty($this->posts) && $this->is_comment_feed && $this->is_singular ) {
			/** This filter is documented in app-includes/query.php */
