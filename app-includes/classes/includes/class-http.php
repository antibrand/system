...
if ( ! class_exists( 'Requests' ) ) {
	require( APP_INC_PATH . '/classes/includes/class-requests.php' );
...
class WP_Http {
	 ...
	 *                                             Default APP_INC_PATH . '/certificates/ca-bundle.crt'.
	...
	public function request( $url, $args = array() ) {
		$defaults = array(
			...
			'decompress' => true,
			'sslverify' => true,
			'sslcertificates' => APP_INC_PATH . '/certificates/ca-bundle.crt',
			'stream' => false,
			'filename' => null,
