 ...
 * query class.
 *
 * The Rewrite along with WP class function as a front controller.
...
class WP_Rewrite {
	...
	/**
	 * Rules that don't redirect to the system index.php.
	 *
	...
	/**
	 * Whether to write every mod_rewrite rule into the .htaccess file.
	 *
	 ...
	 * set to true.
	 *
	 * Tells WP::parse_request() to check if a URL matching the page
	...
	<system.webServer>
		...
		$rules .= '
			<rule name="system: ' . esc_attr( home_url() ) . '" patternSyntax="Wildcard">
				<match url="*" />
					<conditions>
	 ...
	 * @global WP $wp Current system environment instance.
	 *
