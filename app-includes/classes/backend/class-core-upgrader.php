 ...
 *
 * @since 2.8.0
 * @since 4.6.0 Moved to its own file from class-wp-upgrader.php.
 *
 * @see Installer
 */
class Core_Upgrader extends Includes\Installer {
	...
	public function upgrade_strings() {
		$this->strings['up_to_date'] = __('This is at the latest version.');
		...
		$this->strings['rollback_was_required'] = __( 'Due to an error during updating, we has rolled back to your previous version.' );
	}
	 ...
	 *
	 * @param object $current Response object for whether the application is current.
	 * @param array  $args {
	...
	public function upgrade( $current, $args = array() ) {
		...
		include( ABSPATH . APPINC . '/version.php' ); // $wp_version;
	...
	public static function should_update_to_version( $offered_ver ) {
		include( ABSPATH . APPINC . '/version.php' ); // $wp_version; // x.y.z
