...
class MS_Sites_List_Table extends List_Table {
	 ...
	 * @access public
	 * @return bool Returns true if the user can manage sites.
	 */
	 ...
	 * @since  Previous 3.0.0
	 * @access public
	 * @return string Returns the message that no sites are found.
	 */
...
<?php
	 ...
	 * @return mixed Prints the checkbox column output.
	 */
	 ...
	 * @access public
	 * @param  array $blog Current site.
	 * @return mixed Returns the ID column output.
	 */
	 ...
	 * @global string $mode List table view mode.
	 * @param  array $blog Current site.
	 * @return mixed Returns the site name column output.
	 */
	...
	/**
	 * Handles the last updated column output
	 *
	 * @since  Previous 4.3.0
	 * @access public
	 * @global string $mode List table view mode.
	 * @param  array $blog Current site.
	 * @return mixed Returns the last updated column output.
	 */
	public function column_lastupdated( $blog ) {
		...
		if ( $blog['last_updated'] === '0000-00-00 00:00:00' ) {
			...
			$updated = mysql2date( $date, $blog['last_updated'] );
		}
	 ...
	 * @global string $mode List table view mode.
	 * @param  array $blog Current site.
	 * @return mixed Returns the registered column output.
	 */
	 ...
	 * @access public
	 * @param  array $blog Current site.
	 * @return mixed Returns the users column output.
	 */
	 ...
	 * @access public
	 * @param  array $blog Current site.
	 * @return mixed Returns the plugins column output.
	 */
	 ...
	 * @return mixed Returns the output for the default column.
	 */
	...
	/**
	 * Display the list rows
	 *
	 * @since  Previous 3.0.0
	 * @access public
	 * @global string $mode
	 * @return mixed Returns the output of the rows.
	 */
	 ...
	 * @since  Previous 4.3.0
	 * @access protected
	 * @return string Returns the name of the default primary column,
	 *                in this case, 'blogname'.
	 */
	 ...
	 * @return string Retruns the row actions output.
	 */
