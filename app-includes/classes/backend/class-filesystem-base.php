...
class WP_Filesystem_Base {
	...
	/**
	 * Return the path on the remote filesystem of APP_PLUGINS_PATH.
	 *
	 * @since 2.7.0
	 *
	 * @return string The location of the remote path.
	...
	public function wp_plugins_dir() {
		return $this->find_folder(APP_PLUGINS_PATH);
	}
	...
	public function search_for_folder( $folder, $base = '.', $loop = false ) {
		...
		foreach ( $folder_parts as $index => $key ) {
			...
			/*
			 * Working from /home/ to /user/ to /system/ see if that file exists within
			 * the current folder, If it's found, change into it and follow through looking
			 * for it. If it cant find the application down that route, it'll continue onto the next
