...
<div class="wrap" id="custom-background">
	...
	<div class="notice notice-info hide-if-no-customize">
		<p>
			<?php
			printf(
				__( 'You can now manage and preview site backgrounds in the <a href="%1$s">Live Manager</a>.' ),
		...
		<tbody>
			<tr>
				...
				<td>
					...
					?>
					<div id="custom-background-image" style="<?php echo $background_styles; // Must be double quote, see above. ?>">
	...
	<form method="post">
		<table class="form-table">
			<tbody>
				...
				<?php endif; // End get_background_image(). ?>
