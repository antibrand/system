...
class Theme_Upgrader extends Includes\Installer {
	 ...
	 *
	 * @since  Previous 2.8.0
	 * @since  Previous 3.7.0 The `$args` parameter was added, making clearing the update cache optional.
	 * @access public
	...
	public function bulk_upgrade( $themes, $args = [] ) {
		...
		$res = $this->fs_connect( [ APP_VIEWS_PATH ] );
		 ...
		 * - running network and there are one or more themes specified
		 * - a theme with an update available is currently in use.
		 *
		 * @todo For network, maintenance mode should only kick in for
		 *       individual sites if at all possible.
		 */
	 ...
	 *
	 * @since  Previous 2.8.0
	 * @since  Previous 3.0.0 The `$theme` argument was added.
	 * @access public
