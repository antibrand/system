...
?>
	...
	public function single_row( $theme ) {
		...
		?>
		<a class="theme-cover-image install-theme-preview" href="<?php echo esc_url( $preview_url ); ?>" title="<?php echo esc_attr( $preview_title ); ?>">
	...
	public function install_theme_info( $theme ) {
		...
		<div class="install-theme-info"><?php
			...
			<?php if ( isset( $theme->screenshot_url ) ): ?>
				<img class="theme-cover-image" src="<?php echo esc_url( $theme->screenshot_url ); ?>" alt="" />
			<?php endif; ?>
