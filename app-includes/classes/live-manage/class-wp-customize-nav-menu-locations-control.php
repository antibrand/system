<?php
/**
 * Live manager API: WP_Customize_Nav_Menu_Locations_Control class
 *
 * @package App_Package
...
/**
 * Live manager nav Menu locations control class
 *
 * @since 4.9.0
 */
						...
						<p>
							...
							<em class="new-menu-locations-widget-note">
								...
								printf(
									...
									_x( '(If you plan to use a menu widget%1$s, skip this step.)', 'menu locations' ),
