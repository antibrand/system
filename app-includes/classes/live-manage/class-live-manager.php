...
final class WP_Customize_Manager {
	...
	public function __construct( $args = array() ) {
		...
		require_once( ABSPATH . APPINC . '/classes/live-manage/class-wp-customize-themes-panel.php' );
		require_once( ABSPATH . APPINC . '/classes/live-manage/class-wp-customize-themes-section.php' );
		require_once( ABSPATH . APPINC . '/classes/live-manage/class-wp-customize-sidebar-section.php' );
		require_once( ABSPATH . APPINC . '/classes/live-manage/class-wp-customize-nav-menu-section.php' );
		require_once( ABSPATH . APPINC . '/classes/live-manage/class-wp-customize-new-menu-section.php' ); // @todo Remove in 5.0. See #42364.

		require_once( ABSPATH . APPINC . '/classes/live-manage/class-wp-customize-custom-css-setting.php' );
		require_once( ABSPATH . APPINC . '/classes/live-manage/class-wp-customize-filter-setting.php' );
		require_once( ABSPATH . APPINC . '/classes/live-manage/class-wp-customize-header-image-setting.php' );
		require_once( ABSPATH . APPINC . '/classes/live-manage/class-wp-customize-background-image-setting.php' );
		require_once( ABSPATH . APPINC . '/classes/live-manage/class-wp-customize-nav-menu-item-setting.php' );
		require_once( ABSPATH . APPINC . '/classes/live-manage/class-wp-customize-nav-menu-setting.php' );
		...
		require_once( ABSPATH . APPINC . '/classes/live-manage/class-wp-customize-selective-refresh.php' );
