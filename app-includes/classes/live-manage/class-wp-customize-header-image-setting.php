<?php
/**
 * Live manager API: WP_Customize_Header_Image_Setting class
 *
 * @package App_Package
...
final class WP_Customize_Header_Image_Setting extends WP_Customize_Setting {
	...
	public function update( $value ) {
		...
		/**
		 * If _custom_header_background_just_in_time() fails to
		 * initialize $custom_image_header when not is_admin().
		 */
