 ...
 * @since  1.0.0
 * @access public
 * @return void Provides an empty hook.
 */
...
function get_header( $name = null ) {
	 ...
	 * @since Previous 2.8.0 $name parameter added.
 ...
 * form into the sidebar and also by the search widget.
 *
...
function get_search_form( $echo = true ) {
	 ...
	 *
	 * @since Previous 2.7.0 as 'get_search_form' action.
...
function wp_logout_url( $redirect = '' ) {
	...
	$logout_url = add_query_arg( $args, site_url( 'app-login.php', 'login' ) );
...
function wp_login_url( $redirect = '', $force_reauth = false ) {
	...
	$login_url = site_url( 'app-login.php', 'login' );
	 ...
	 *
	 * @since Previous 2.8.0
	 * @since Previous 4.2.0 The `$force_reauth` parameter was added.
...
function wp_registration_url() {
	 ...
	 */
	return apply_filters( 'register_url', site_url( 'app-login.php?action=register', 'login' ) );
}
...
function wp_login_form( $args = [] ) {
	...
	$form = '
		<form name="' . $args['form_id'] . '" id="' . $args['form_id'] . '" action="' . esc_url( site_url( 'app-login.php', 'login_post' ) ) . '" method="post">
			' . $login_form_top . '
 ...
 *
 * @since Previous 4.1.0
 * @since Previous 4.7.0 Added support for author archives.
 * @since Previous 4.9.0 Added support for post type archives.
 *
...
function get_archives_link($url, $text, $format = 'html', $before = '', $after = '' ) {
	 ...
	 * @since Previous 4.5.0 Added the `$url`, `$text`, `$format`, `$before`, and `$after` parameters.
	 *
 ...
 * @since Previous 4.4.0 $post_type arg was added.
 *
 ...
 *
 * @since Previous 2.1.0
 * @since Previous 4.6.0 Added the `$post` parameter.
 *
 * @param string      $d    Optional. PHP date format defaults to the date_format option if not specified.
 * @param int|WP_Post $post Optional. Post ID or WP_Post object. Default current post.
...
function get_language_attributes( $doctype = 'html' ) {
	 ...
	 *
	 * @since Previous 2.5.0
	 * @since Previous 4.3.0 Added the `$doctype` parameter.
	 *
 ...
 *
 * @since Previous 2.1.0
 * @since Previous 4.3.0 Converted into a wrapper for get_language_attributes().
 *
 * @param string $doctype Optional. The type of html document. Accepts 'xhtml' or 'html'. Default 'html'.
 */
 ...
 *
 * @since Previous 2.1.0
 * @since Previous 4.9.0 Added the `aria_current` argument.
 *
 ...
 *
 * @since Previous WP 3.0.0 User color schemes feature.
 * @since Previous 1.0.0 Using `app_assets_url`.
 */
