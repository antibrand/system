...
require( ABSPATH . APP_INC . '/classes/includes/class-app-hook.php' );
 ...
 *
 * Filter hooks to allow plugins to modify
...
function plugin_basename( $file ) {
	...
	$plugin_dir = wp_normalize_path( APP_PLUGINS_PATH );
...
function wp_register_plugin_realpath( $file ) {
	...
	if ( ! isset( $wp_plugin_path ) ) {
		$wp_plugin_path   = wp_normalize_path( APP_PLUGINS_PATH );
		$wpmu_plugin_path = wp_normalize_path( APP_EXTENSIONS_PATH );
	}
