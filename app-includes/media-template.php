...
function wp_print_media_templates() {
	...
	<script type="text/html" id="tmpl-uploader-inline">
		...
		<?php elseif ( is_network() && ! is_upload_space_available() ) : ?>
			...
			<?php
			/** This action is documented in APP_INC_PATH . '/backend/media.php */
	...
	<script type="text/html" id="tmpl-site-icon-preview">
		...
		<div class="favicon-preview">
			<img src="<?php echo esc_url( app_assets_url( 'images/' . ( is_rtl() ? 'browser-rtl.png' : 'browser.png' ) ) ); ?>" class="browser-preview" width="182" height="" alt="" />
