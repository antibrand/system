...
function wp_mail( $to, $subject, $message, $headers = '', $attachments = array() ) {
	...
	/* If we don't have an email from the input headers default to system@$sitename
...
function wp_notify_postauthor( $comment_id, $deprecated = null ) {
	...
	$wp_email = 'system@' . preg_replace('#^www\.#', '', strtolower($_SERVER['SERVER_NAME']));
...
function wp_new_user_notification( $user_id, $deprecated = null, $notify = '' ) {
	...
	$message .= '<' . network_site_url("app-login.php?action=rp&key=$key&login=" . rawurlencode($user->user_login), 'login') . ">\r\n\r\n";
...
function wp_rand( $min = 0, $max = 0 ) {
	...
	if ( strlen($rnd_value) < 8 ) {
		...
		if ( ! defined( 'WP_SETUP_CONFIG' ) && ! defined( 'APP_INSTALLING' ) ) {
