...
function update_metadata($meta_type, $object_id, $meta_key, $meta_value, $prev_value = '') {
	 ...
	 *
	 * The dynamic portion of the hook, `$meta_type`, refers to the meta
	 * object type (comment, post, or term, user). Returning a non-null value
	 * will effectively short-circuit the function.
	 *
	 * @since 3.1.0
	 *
...
function metadata_exists( $meta_type, $object_id, $meta_key ) {
	...
	/** This filter is documented in app-includes/meta.php */
...
function update_metadata_by_mid( $meta_type, $meta_id, $meta_value, $meta_key = false ) {
	...
	if ( $meta = get_metadata_by_mid( $meta_type, $meta_id ) ) {
		...
		/** This action is documented in app-includes/meta.php */
		do_action( "update_{$meta_type}_meta", $meta_id, $object_id, $meta_key, $_meta_value );
 ...
 * @global wpdb $wpdb Database abstraction object.
 *
 * @param string $meta_type Type of object metadata is for (e.g., comment, post, term, term, or user).
 * @param int    $meta_id   ID for a specific meta row
 * @return bool True on successful delete, false on failure.
 */
