...
require_once( ABSPATH . APP_INC . '/classes/includes/class-pop3.php' );
...
if ( $last_checked ) {
	wp_die( __( 'New mail was recently checked. It will be checked again soon.' ) );
}
	...
	foreach ( $message as $line ) {
		...
		if ( $bodysignal ) {
			...
			if ( preg_match( '/Subject: /i', $line ) ) {
				...
				// Capture any text in the subject before $phone_delim as the subject.
