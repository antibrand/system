...
class WP_Widget_Custom_HTML extends WP_Widget {
	 ...
	 *
	 * @since Previous 4.8.1
	 * @since Previous 4.9.0 The form contains only hidden sync inputs. For the control UI, see `WP_Widget_Custom_HTML::render_control_template_scripts()`.
	 *
	...
	public static function add_help_text() {
		...
		$content = apply_filters( 'help_html_widget', $content );
