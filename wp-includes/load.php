...
function wp_check_php_mysql_versions() {
	...
	if ( version_compare( $required_php_version, $php_version, '>' ) ) {
		...
		die( sprintf( __( 'Your server is running PHP version %1$s but the application %2$s requires at least %3$s.' ), $php_version, $wp_version, $required_php_version ) );
	}
...
/**
 * Redirect to the installer if the application is not installed.
 *
