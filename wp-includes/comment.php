 ...
 * and whether comment is approved. Also has {@see 'preprocess_comment'}
...
/**
 * Handles the submission of a comment, usually posted to app-comments-post.php via a comment form.
 *
