...
!(function () {
    ...
    var fe,
        ...
        qe = function (e, t) {
            ...
            if (
                ...
                Re.experimentalShadowDom && (s.target = ((r = e), (o = s.target), (a = o), (i = r.path) && 0 < i.length && (a = i[0]), r.composedPath && (i = r.composedPath()) && 0 < i.length && (a = i[0]), a)),
                            ...
                            b.domLoaded && "ready" === u && "complete" === e.readyState
                                ...
                                : (h ||
                                  ...
                                  (i = y[o][u])
                                      ...
                                      : ((y[o][u] = i = [{ func: n, scope: r }]), (i.fakeName = s), (i.capture = l), (i.nativeHandler = c), "ready" === u ? He(e, c, b) : ze(e, s || u, c, l)));
                    return (e = i = 0), n;
                }
            }),
            ...
            ? ((Se = (Ee = s).documentElement),
              ...
              (Qe = t
                  ? function (e, t) {
                        ...
                        return (
                            n ||
                            (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || (!me.sortDetached && t.compareDocumentPosition(e) === n)
    ...
    (Tt.matchesSelector = function (e, t) {
        if (((e.ownerDocument || e) !== Ee && Ne(e), (t = t.replace(gt, "='$1']")), me.matchesSelector && Te && (!Ae || !Ae.test(t)) && (!ke || !ke.test(t))))
            try {
        ...
        preFilter: {
            ...
            PSEUDO: function (e) {
                ...
                return vt.CHILD.test(e[0])
                    ? null
                    : (e[3] ? (e[2] = e[4] || e[5] || "") : n && pt.test(n) && (t = ve(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))), e.slice(0, 3));
            },
        },
        filter: {
            TAG: function (e) {
    ...
    var Sn = function (n) {
        ...
        Bn = function (e) {
            var t = e.current;
            return { current: t, version: e.version, isEdge: Dn("Edge", t), isChrome: Dn("Chrome", t), isIE: Dn("IE", t), isOpera: Dn("Opera", t), isFirefox: Dn(Rn, t), isSafari: Dn("Safari", t) };
        },
        On = {
            unknown: function () {
        ...
        Un = function (e) {
            var t = e.current;
            return { current: t, version: e.version, isWindows: Fn(Pn, t), isiOS: Fn("iOS", t), isAndroid: Fn(Ln, t), isOSX: Fn("OSX", t), isLinux: Fn("Linux", t), isSolaris: Fn(In, t), isFreeBSD: Fn(Mn, t) };
        },
        zn = {
            unknown: function () {
        ...
        Jn = function (e) {
            ...
            return {
                ...
                deviceType:
                    ...
                    { isiPad: H(o), isiPhone: H(i), isTablet: H(s), isPhone: H(l), isTouch: H(c), isAndroid: t.isAndroid, isiOS: t.isiOS, isWebView: H(f) }),
            };
        },
        Qn = {
            detect: Sn(function () {
        ...
        Yr = {
            getPos: function (e, t, n) {
                var r,
                    ...
                    s = e.ownerDocument;
                if (((n = n || e), t)) {
                    if (n === e && t.getBoundingClientRect && "static" === Tr(er.fromDom(e), "position"))
                        return {
            ...
            decode: function (e) {
                return e.replace(zo, function (e, t) {
                    return t
                        ...
                        : so[e] || ao[e] || ((n = e), ((r = er.fromTag("div").dom()).innerHTML = n), r.textContent || r.innerText || n);
                    var n, r;
                });
            },
        },
        ...
        ti = function (e) {
            var u,
                ...
                a = function (e, t, n) {
                    ...
                    for (t = t || "", "string" == typeof (n = n || []) && (n = ei(n)), r = (e = ei(e)).length; r--; ) (i = { attributes: a((o = ei([u, t].join(" ")))), attributesOrder: o, children: a(n, Xo) }), (s[e[r]] = i);
                },
                c = function (e, t) {
                    var n, r, o, i;
                    for (n = (e = ei(e)).length, t = ei(t); n--; ) for (r = s[e[n]], o = 0, i = t.length; o < i; o++) (r.attributes[t[o]] = {}), r.attributesOrder.push(t[o]);
                };
            return Ko[e]
                ? Ko[e]
    ...
    function ri(i) {
        ...
        (n = ti((i = i || {}).schema)),
            ...
            Go((i.special || "script noscript noframes noembed title style textarea xmp").split(" "), function (e) {
                h[e] = new RegExp("</" + e + "[^>]*>", "gi");
            });
        var S = function (e) {
        ...
        return (
            ...
            x("+ol[ul|ol],+ul[ul|ol]"),
            Go({ dd: "dl", dt: "dl", li: "ul ol", td: "tr", th: "tr", tr: "tbody thead tfoot", tbody: "table", thead: "table", tfoot: "table", legend: "fieldset", area: "map", param: "video audio object" }, function (e, t) {
    ...
    var Gi,
        ...
        ea = {
            ...
            sibling: function (t, n) {
                var e = t.dom();
                return e.parentNode
                    ? Qi(er.fromDom(e.parentNode), function (e) {
        ...
        Ga = Math.round,
        Ja = function (e) {
            return e ? { left: Ga(e.left), top: Ga(e.top), bottom: Ga(e.bottom), right: Ga(e.right), width: Ga(e.width), height: Ga(e.height) } : { left: 0, top: 0, bottom: 0, right: 0, width: 0, height: 0 };
        },
        Qa = function (e, t) {
        ...
        wu = function (e) {
            var t, n, r, o, i, a, u, s;
            return (
                (t = 0 < (n = e.getClientRects()).length ? Ja(n[0]) : Ja(e.getBoundingClientRect())),
                !yu(e) && gu(e) && xu(t)
                    ? ((i = (r = e).ownerDocument), (a = vu(i)), (u = i.createTextNode("\xa0")), (s = r.parentNode).insertBefore(u, r), a.setStart(u, 0), a.setEnd(u, 1), (o = Ja(a.getBoundingClientRect())), s.removeChild(u), o)
                    : xu(t) && yu(e)
                    ? (function (e) {
                          var t = e.startContainer,
                              n = e.endContainer,
    ...
    var Tu,
        ...
        Lu = function (e) {
            var t, r, n, o;
            return (
                (_u(e) ? "text()" : e.nodeName.toLowerCase()) +
                "[" +
                ((r = Ou(Bu((t = e)))),
                (n = jt.findIndex(r, Pu(t), t)),
                (r = r.slice(0, n + 1)),
                (o = jt.reduce(
                    r,
                    function (e, t, n) {
                ...
                (r = jt.filter(r, Bo.matchNodeNames(t.nodeName))),
                (n = jt.findIndex(r, Pu(t), t)) - o) +
                "]"
            );
        },
        Iu = function (e, t) {
                ...
                ? ((t = (n = t.split(","))[0].split("/")),
                  ...
                  (r = jt.reduce(
                      ...
                      function (e, t) {
                          return (t = /([\w\-\(\)]+)\[([0-9]+)\]/.exec(t))
                              ? ("text()" === t[1] && (t[1] = "#text"),
                                ...
                                (i = jt.filter(i, Bo.matchNodeNames(r)))[o])
                              : null;
                          var n, r, o, i;
                      },
                      e
                      ...
                      ? _u(r)
                          ...
                          : ((o = "after" === o ? Du(r) + 1 : Du(r)), Au(r.parentNode, o))
                      : null)
                : null;
        },
        ...
        $u = function (e, t, n) {
            ...
            var a,
                ...
                f,
                d,
                m = ju((a = i).startContainer, a.startOffset) || ju(a.endContainer, a.endOffset);
        ...
        Xu = {
            getBookmark: function (e, t, n) {
                return 2 === t ? $u(Ta, n, e) : 3 === t ? ((o = (r = e).getRng()), { start: Iu(r.dom.getRoot(), Au.fromRangeStart(o)), end: Iu(r.dom.getRoot(), Au.fromRangeEnd(o)) }) : t ? { rng: e.getRng() } : Ku(e, !1);
                var r, o;
            },
    ...
    var gs,
        ...
        Ss = function (e, t, n) {
            ...
            if (vs(f)) {
                ...
                if (Pc(e) && d < f.childNodes.length && ((o = Ns(f, d)), Cs(o)))
                    return ys(o) && n.lastChild === o
                        ? null
                        : ((s = o),
                          (c = n),
                          Bo.isBr(s) && (l = Ss(1, Au.after(s), c)) && !Uc(Au.before(s), Au.before(l), c) ? Ss(e, Au.after(o), n) : !xs(o) && (i = Mc(o, e, ws, o)) ? (vs(i) ? Au(i, 0) : Au.before(i)) : vs(o) ? Au(o, 0) : Au.after(o));
                r = o || u.getNode();
            }
            return ((Pc(e) && u.isAtEnd()) || (Lc(e) && u.isAtStart())) && ((r = Mc(r, e, wa.constant(!0), n, !0)), ws(r, n))
                ? Es(e, r)
                : ((o = Mc(r, e, ws, n)),
                  !(a = jt.last(
                      jt.filter(
    ...
    var ks,
            ...
            for (var o, i, a, u, s, c, l = Ts(n), f = r, d = []; f && ((s = l), (c = f), (o = t === Tu.Forwards ? s.next(c) : s.prev(c))); ) {
                ...
                if (o.isVisible()) {
                    if (e(f, o)) {
                        ...
                        return { positions: Bs(t, d), breakType: m, breakAt: A.some(o) };
                    }
                    d.push(o), (f = o);
                } else f = o;
            }
        ...
        Vs = function (e, t, n, r, o) {
            var i,
                ...
                u,
                s,
                c = Xi(er.fromDom(n), "td,th").map(function (e) {
                    return e.dom();
                }),
                l = U(
                    ((i = e),
                    G(c, function (e) {
                        var t,
                            n,
                            r = ((t = e.getBoundingClientRect()), (n = -1), { left: t.left - n, top: t.top - n, right: t.right + 2 * n, bottom: t.bottom + 2 * n, width: t.width + n, height: t.height + n });
                        return [
        ...
        gc = function (t, n, e) {
            var r = t(n, e);
            return r.breakType === gs.Wrap && 0 === r.positions.length
                ? r.breakAt
                      .map(function (e) {
        ...
        Ec = function (e, t, n) {
            var r,
                ...
                a,
                u,
                s = Qa(t.getBoundingClientRect(), n);
            return (
                "BODY" === e.tagName
        ...
        il = function (e, t) {
            ...
            return Bo.isText(u)
                ? A.some(Au(u, e ? 0 : u.data.length))
                : u
                ? Ka(u)
                    ? A.some(e ? Au.before(u) : ((a = u), Bo.isBr(a) ? Au.before(a) : Au.after(a)))
                    : ((r = t), (o = u), (i = (n = e) ? Au.before(o) : Au.after(o)), ol(n, r, i))
                : A.none();
        },
        al = {
            fromPosition: ol,
        ...
        sl = function (e, t) {
            return al.lastPositionIn(e).fold(
                function () {
                    return !1;
                },
                function (e) {
        ...
        ml = function (e, t) {
            ...
            if (t) {
                ...
                if ("string" == typeof t.start)
                    return A.some(((f = t), (d = (l = b).createRng()), (m = Mu(l.getRoot(), f.start)), d.setStart(m.container(), m.offset()), (m = Mu(l.getRoot(), f.end)), d.setEnd(m.container(), m.offset()), d));
                if (t.hasOwnProperty("id"))
                    return (
                        (s = dl((o = b), "start", (i = t))),
                        (c = dl(o, "end", i)),
                        au([s, ((a = c), (u = s), a.isSome() ? a : u)], function (e, t) {
                            var n = o.createRng();
        ...
        Al = function (e, t, n, r, o, i) {
            ...
            for (a = new io(n, e.getParent(n, e.isBlock) || t); (u = a[o ? "prev" : "next"]()); )
                if (3 === u.nodeType) {
                    if (-1 !== (s = kl(o, i, (c = u)))) return { container: u, offset: s };
        ...
        Bl = function (e, t, n, r) {
            var o,
                ...
                c = e.dom;
            return (
                1 === i.nodeType && i.hasChildNodes() && 3 === (i = ru(i, a)).nodeType && (a = 0),
                ...
                n[0].inline &&
                    (t.collapsed && ((o = Al(c, e.getBody(), i, a, !0, r)) && ((i = o.container), (a = o.offset)), (o = Al(c, e.getBody(), u, s, !1, r)) && ((u = o.container), (s = o.offset))),
                    (u = r
                        ? u
                        : (function (e, t) {
                              var n = Sl(e, t);
        ...
        Ml = function (r, o, i, a) {
            return Wr.parent(o).fold(
                function () {
                    return "skipping";
                },
                function (e) {
                    return "br" === a || ((n = o), sr.isText(n) && "\ufeff" === Il(n))
                        ? "skipping"
                        : ((t = o), sr.isElement(t) && Ki.has(t, ia()) ? "existing" : Gu(o) ? "caret" : Cl.isValid(r, i, a) && Cl.isValid(r, sr.name(e), i) ? "valid" : "invalid-child");
                    var t, n;
                }
            );
        },
    ...
    var ql = function (e) {
        ...
        Yl = function (e, o, i, t) {
            ...
            return k(1)
                ? Kl(E, S, T)
                : k(2)
                ? ((f = E), (d = S), (m = T), o.insertAfter(d.reverse(), f), Wl(d[0], m))
                : ((p = S),
                  (h = T),
                  (v = g = E),
                  (y = (b = i).cloneRange()),
    ...
    var af = function (a) {
        ...
        cf = function (o, e, t) {
            ...
            if (
                ...
                (n = o.parser),
                (g = t.merge),
                (r = of({ validate: o.settings.validate }, o.schema)),
                ...
                w === N &&
                    ...
                    h.isCollapsed() ||
                        (o.selection.setRng(uf(o.selection.getRng())),
                        o.getDoc().execCommand("Delete", !1, null),
                        (C = (y = h.getRng()).startContainer),
                        (x = y.startOffset),
                        3 === C.nodeType && y.collapsed && ("\xa0" === C.data[x] ? (C.deleteData(x, 1), /[\u00a0| ]$/.test(e) || (e += " ")) : "\xa0" === C.data[x - 1] && (C.deleteData(x - 1, 1), /[\u00a0| ]$/.test(e) || (e = " " + e))));
                var E,
                    S,
                    T,
                        ...
                        if (e) {
                            ...
                            (l = v.createRng()),
                                (f = e.previousSibling) && 3 === f.nodeType
                                    ? (l.setStart(f, f.nodeValue.length), Re.ie || ((d = e.nextSibling) && 3 === d.nodeType && (f.appendData(d.data), d.parentNode.removeChild(d))))
        ...
        Ef = function (e, t) {
            ...
            return e
                ...
                ? Bo.isText(n.previousSibling)
                    ? Au(n.previousSibling, n.previousSibling.data.length)
                    : Au.before(n)
                : Pa(t)
                ? Au(n, r - 1)
                : t;
        ...
        Sf = {
            ...
            findRootInline: function (e, t, n) {
                var r,
                    o,
                    i,
                    a = ((r = e), (o = t), (i = n), U(hi.DOM.getParents(i.container(), "*", o), r));
        ...
        Uf = function (o, i, e) {
                    ...
                    return al.fromPosition(i, o, e.position()).bind(function (e) {
                        return Ff(o, e).map(function (e) {
                            return (
                                ...
                                (n = i),
                                (r = e),
                                Bo.isBr(r.position().getNode()) && !1 === Lf(r.block())
                                    ? al
                                          .positionIn(!1, r.block().dom())
                                          .bind(function (e) {
                                              return e.isEqual(r.position())
                                                  ? al.fromPosition(n, t, e).bind(function (e) {
                                                        return Ff(t, e);
                                                    })
                                                  : A.some(r);
                                          })
            ...
            return au([t, n], Mf).filter(function (e) {
                return (
                    (r = e),
                    !1 === Ur.eq(r.from().block(), r.to().block()) &&
                        ((n = e),
                        Wr.parent(n.from().block())
                            .bind(function (t) {
                            ...
                            .isSome()) &&
                        ((t = e), !1 === Bo.isContentEditableFalse(t.from().block()) && !1 === Bo.isContentEditableFalse(t.to().block()))
                );
                var t, n, r;
            });
        },
        ...
        Vf = function (e, t, n) {
            return Ur.contains(t, e)
                ? Wr.parents(e, function (e) {
        ...
        Xf = function (o, i) {
            return Ur.contains(i, o)
                ? Wr.parent(o).bind(function (e) {
                      return Ur.eq(e, i)
                          ? A.some(o)
                          : ((t = i),
                            (n = o),
                            (r = Wr.parents(n, function (e) {
                                return Ur.eq(e, t);
                            })),
                            A.from(r[r.length - 2]));
                      var t, n, r;
        ...
        Jf = function (t, n) {
            ...
            return (
                (e = zf(r.dom(), n, t.selection.getRng()).bind(function (e) {
        ...
        Zf = function (e, t) {
            var n,
                r,
                o = al.prevPosition(e.dom(), Au.fromRangeStart(t)).isNone(),
        ...
        ed = function (e) {
            ...
            return Zf(i, a)
                ...
                : ((n = i),
                  (r = e.selection),
                  (o = r.getRng()),
                  au([Tf(n, er.fromDom(o.startContainer)), Tf(n, er.fromDom(o.endContainer))], function (e, t) {
                      return (
                          !1 === Ur.eq(e, t) &&
                          (o.deleteContents(),
                          Gf(n, !0, e, t).each(function (e) {
                              r.setRng(e.toRange());
                          }),
                          !0)
                      );
        ...
        od = function (e, t, n, r) {
            var o = r.getNode(!1 === t);
            return Tf(er.fromDom(e), er.fromDom(n.getNode()))
                .map(function (e) {
        ...
        id = function (u, s, c) {
            return al.fromPosition(s, u, c).bind(function (e) {
                return (
                    (a = e.getNode()),
                    Co(er.fromDom(a)) || vo(er.fromDom(a))
                        ? A.none()
                        : ((t = u),
                          (o = e),
                          (i = function (e) {
        ...
        ad = function (r, e, o) {
            return (
                ...
                Bo.isElement(a) && a.getAttribute("data-mce-caret") === u
                    ? ((t = e),
                      (n = o.getNode(!1 === e)),
                      t && Bo.isContentEditableFalse(n.nextSibling) ? A.some(rd.moveToElement(n.nextSibling)) : !1 === t && Bo.isContentEditableFalse(n.previousSibling) ? A.some(rd.moveToElement(n.previousSibling)) : A.none()).fold(
                          function () {
                              return id(r, e, o);
                          },
                          A.some
                      )
                    : id(r, e, o).bind(function (e) {
                          return (
                              (t = r),
                              (n = o),
                              e.fold(
        ...
        hd = function (t, n, e) {
            var r,
                ...
                s =
                    ((a = e),
                    (o = i),
                    au([Wr.prevSibling(a), Wr.nextSibling(a), o], function (e, t, n) {
                        var r,
                            o = e.dom(),
                            i = t.dom();
        ...
        vd = function (a, u) {
            ...
            (r = $c(t ? 1 : -1, e, n)),
            (o = Au.fromRangeStart(r)),
            !1 === t && Jc(o) ? A.some(rd.remove(o.getNode(!0))) : t && Gc(o) ? A.some(rd.remove(o.getNode())) : ad(e, t, o))
                .map(function (e) {
                    return e.fold(
                        ((o = a),
                        (i = u),
            ...
            move: function (a, u, s) {
                return function () {
                    return (
                        ...
                        (e = s),
                        (r = t.getBody()),
                        (o = Au.fromRangeStart(t.selection.getRng())),
                        (i = b(Sf.isInlineTarget, t)),
        ...
        lm = function (n, r, i, o) {
            var e,
                t,
                a = ((e = n.getBody()), (t = o.container()), Fc(t, e) || e),
            ...
            return s
                ...
                .getOrThunk(function () {
                    ...
                    return s.isSome() && e.isSome()
                        ? Sf.findRootInline(u, a, o)
                              .map(function (e) {
                                  return (
                                      (o = e),
                                      !!au([al.firstPositionIn(o), al.lastPositionIn(o)], function (e, t) {
                                          var n = Sf.normalizePosition(!0, e),
                                              r = Sf.normalizePosition(!1, t);
                                          return al
                                              .nextPosition(o, n)
        ...
        wm = function (e, t) {
            ...
            return ((r = t),
            (o = u),
            (i = pm(r.startContainer, o)),
            (a = pm(r.endContainer, o)),
            au([i, a], dm)
                .filter(vm)
                .filter(function (e) {
                    return xm(o, e);
        ...
        Em = function (n) {
            return ((r = n),
            au([Nm(r.cells(), r.rng().start()), Nm(r.cells(), r.rng().end())], function (e, t) {
                ...
                .bind(function (e) {
                    return (
                        ...
                        al
                            ...
                            : ((t = l),
                              (n = e),
                              Um(s, er.fromDom(n.getNode())).map(function (e) {
                                  return !1 === Ur.eq(e, t);
                              }))
                    );
                    var t, n, r, o, i, a;
            ...
            return Fm(s, e).bind(function (e) {
                return Lf(e)
                    ...
                    : ((t = a),
                      ...
                      (o = e),
                      (i = c),
                      al.navigate(r, t.getBody(), i).bind(function (e) {
        ...
        ag = function (e, t) {
            ...
            return (
                ig(e, n, !0, r).each(function (e) {
                    (n && Su.isAbove(o, e)) || r.setStart(e.container(), e.offset());
                }),
                n ||
                    ig(e, n, !1, r).each(function (e) {
        ...
        hg = function (e, t) {
            var n,
                r,
                o,
                i = ((n = e), (r = b(Sf.isInlineTarget, n)), (o = Au.fromRangeStart(n.selection.getRng())), Yd(r, n.getBody(), o).filter(gg));
    ...
    function qg(s) {
        ...
        Ug(this, {
            execCommand: function (t, n, r, e) {
                var o,
                    ...
                    a = !1;
                if (!s.removed) {
                    if ((/^(mceAddUndoLevel|mceEndUndoLevel|mceBeginUndoLevel|mceRepaint)$/.test(t) || (e && e.skip_focus) ? Lg(s) : s.focus(), (e = s.fire("BeforeExecCommand", { command: t, ui: n, value: r })).isDefaultPrevented()))
                        return !1;
                    if (((i = t.toLowerCase()), (o = c.exec[i]))) return o(i, n, r), s.fire("ExecCommand", { command: t, ui: n, value: r }), !0;
                    if (
                        (Fg(s.plugins, function (e) {
        ...
        e({
            ...
            "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull,JustifyNone": function (e) {
                var t = e.substring(7);
                "full" === t && (t = "justify"),
                    Fg("left,center,right,justify".split(","), function (e) {
    ...
    var $g,
        ...
        Kg = {
            fire: function (e, t, n) {
                ...
                if (((t = Wg(this).fire(e, t, n)), !1 !== n && this.parent)) for (var r = this.parent(); r && !t.isPropagationStopped(); ) r.fire(e, t, !1), (r = r.parent());
                return t;
            },
            on: function (e, t, n) {
        ...
        tp = function (e, t) {
            ...
            (n = er.fromDom(e.getBody())),
                ...
                t
                    ...
                    : ((e.readonly = !1), (e.getBody().contentEditable = "true"), ep(e, "StyleWithCSS", !1), ep(e, "enableInlineTableEditing", !1), ep(e, "enableObjectResizing", !1), e.focus(), e.nodeChanged());
        },
        np = function (e) {
        ...
        op = function (e, t) {
            return "selectionchange" === t
                ...
                ? (e.eventRoot || (e.eventRoot = rp.select(e.settings.event_root)[0]), e.eventRoot)
                : e.getBody();
        },
        ip = function (e, t, n) {
            var r;
        ...
        up = {
            ...
            toggleNativeEvent: function (e, t) {
                ...
                "focus" !== e &&
                    "blur" !== e &&
                    (t ? (n.initialized ? ap(n, e) : n._pendingNativeEvents ? n._pendingNativeEvents.push(e) : (n._pendingNativeEvents = [e])) : n.initialized && (n.dom.unbind(op(n, e), e, n.delegates[e]), delete n.delegates[e]));
            },
    ...
    function mp(i) {
        var a = {},
            ...
            s = function (e, t, n, r) {
                var o;
                return ((o = Yt.map(lp(e, ">"), u))[o.length - 1] = Yt.extend(o[o.length - 1], { func: n, scope: r || i })), Yt.extend(o[0], { desc: i.translate(t), subpatterns: o.slice(1) });
            },
            o = function (e, t) {
            ...
            0 !== r.src.indexOf("blob:")
                ? ((i = eh(r.src).data),
                  (a = n.findFirst(function (e) {
                      ...
                      : Qp(r.src).then(
                            function (e) {
                                (a = n.create(nh(), e, i)), n.add(a), o({ image: r, blobInfo: a });
                            },
                            function (e) {
                                t(e);
                            }
                ...
                : Qp(r.src).then(
                      function (t) {
                          Zp(t).then(function (e) {
                              (i = eh(e).data), (a = n.create(nh(), t, i)), n.add(a), o({ image: r, blobInfo: a });
                          });
                      },
                      function (e) {
                          t(e);
    ...
    function uh(u) {
        var n,
            ...
            C = function (n) {
                return (
                    a || (a = Wp(m, { url: d.images_upload_url, basePath: d.images_upload_base_path, credentials: d.images_upload_credentials, handler: d.images_upload_handler })),
                    N().then(
                        g(function (r) {
                            var e;
                            return (
                                ...
                                a.upload(e, b).then(
                                    g(function (e) {
                                        var t = jt.map(e, function (e, t) {
                                            var n = r[t].image;
                                            return e.status && !1 !== u.settings.images_replace_blob_uris ? y(n, e.url) : e.error && zp(u, e.error), { element: n, status: e.status };
                                        });
                                        return n && n(t), t;
                                    })
                                )
    ...
    var sh = function (e, t) {
            ...
            if (
                ...
                v &&
                    ...
                    p.isValidChild(l, f.toLowerCase()) &&
                        ...
                        (C = b),
                        (x = v),
                        !M(Hf(er.fromDom(x), er.fromDom(C)), function (e) {
                            return sh(y, e.dom());
                        }))))
            ) {
                var y, C, x, w, N;
        ...
        gh = function (o, e) {
            return au(
                [
                    ((i = e), (a = i.startContainer), (u = i.startOffset), Bo.isText(a) ? (0 === u ? A.some(er.fromDom(a)) : A.none()) : A.from(a.childNodes[u]).map(er.fromDom)),
                    ((t = e), (n = t.endContainer), (r = t.endOffset), Bo.isText(n) ? (r === n.data.length ? A.some(er.fromDom(n)) : A.none()) : A.from(n.childNodes[r - 1]).map(er.fromDom)),
                ],
                function (e, t) {
    ...
    var bh,
        ...
        xh = function (e, t) {
            return (
                (n = (u = e).inline ? Ch(u.getBody()) : { left: 0, top: 0 }),
                (a = (i = e).getBody()),
    ...
    var Dh = function (o, i, a, e, u, t) {
        ...
        Hh = function (e, t, n) {
            var r,
                ...
                c,
                l,
                f = Rh(((o = e), jt.filter(jt.toArray(o.getElementsByTagName("*")), Tc))),
            ...
            return (r = Vh(d, t)) &&
                (r = Vh(
                    ...
                    (c = []).push((s = r)),
                    qh(bh.Up, u, b(l, eu), s.node),
                    qh(bh.Down, u, b(l, tu), s.node),
                    c),
                    t
                )) &&
                Tc(r.node)
                ? ((a = t), { node: (i = r).node, before: Fh(i, a) < Uh(i, a) })
                : null;
        },
        jh = function (i, a, e) {
            return (
                              ...
                              Xh(n)
                                  ? ((l = f = n.cloneNode(!0)),
                                    (s = g.fire("ObjectSelected", { target: n, targetClone: l })).isDefaultPrevented()
                                        ? null
                                        : ((r = ra(er.fromDom(g.getBody()), "#" + h).fold(
                                              function () {
                                                  return d([]);
                                              },
                                              function (e) {
                                          ...
                                          o.addRange(e),
                                          F(Xi(er.fromDom(g.getBody()), "*[data-mce-selected]"), function (e) {
                    ...
                    ((function () {
                        ...
                        var n,
                            ...
                            i = function (e, t) {
                                ...
                                return (
                                    !(!o || !g.dom.isChildOf(o, i) || !1 !== Xh(Jh(g, o))) ||
                                    (o &&
                ...
                for (
                    ...
                    if ((R < t.index && q(O(e.substr(R, t.index - R))), (n = t[6]))) ":" === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)), I(n);
                        ...
                        if ((":" === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)), (c = n in s), _ && E[n] && 0 < D.length && D[D.length - 1].name === n && I(n), !p || (l = U.getElementRule(n)))) {
                            if (
                                ((f = !0), p && ((b = l.attributes), (y = l.attributePatterns)), (v = t[8]) ? ((m = -1 !== v.indexOf("data-mce-type")) && u && (f = !1), ((d = []).map = {}), v.replace(T, M)) : ((d = []).map = {}), p && !m)
                            ) {
                        ...
                        (n = t[1])
                            ? (">" === n.charAt(0) && (n = " " + n), F.allow_conditional_comments || "[if" !== n.substr(0, 3).toLowerCase() || (n = " " + n), z(n))
                            : (n = t[2])
                            ? V(n.replace(/<!--|-->/g, ""))
                            : (n = t[3])
                            ? W(n)
    ...
    var tv = ev,
        nv = function (e, t) {
            ...
            for (u = e.getTempAttrs(), s = l, c = new RegExp(["\\s?(" + u.join("|") + ')="[^"]+"'].join("|"), "gi"), l = s.replace(c, ""), a = d.getShortEndedElements(); (i = f.exec(l)); )
                (r = f.lastIndex), (o = i[0].length), (n = a[i[1]] ? r : tv.findEndTag(d, l, r)), (l = l.substring(0, r - o) + l.substring(n)), (f.lastIndex = r - o);
            return Ta(l);
        },
        ...
        wv = function (e, t, n) {
            "fragmented" === t.type ? fv(t.fragments, e.getBody()) : e.setContent(t.content, { format: "raw" }), e.selection.moveToBookmark(n ? t.beforeBookmark : t.bookmark);
        },
        Nv = function (e, t) {
        ...
        return (
            ...
            u.on("KeyUp", function (e) {
                ...
                e.isDefaultPrevented() ||
                    ...
                    r && o.typing && !1 === Nv(xv(u), l[0]) && (!1 === u.isDirty() && (d(!0), u.fire("change", { level: l[0], lastLevel: null })), u.fire("TypingUndo"), (r = !1), u.nodeChanged()));
            }),
            ...
            (o = {
                ...
                undo: function () {
                    var e;
                    return o.typing && (o.add(), (o.typing = !1), i(!1)), 0 < c && ((e = l[--c]), wv(u, e, !0), d(!0), u.fire("undo", { level: e })), e;
                },
                redo: function () {
                    var e;
                    return c < l.length - 1 && ((e = l[++c]), wv(u, e, !1), d(!0), u.fire("redo", { level: e })), e;
                },
                clear: function () {
    ...
    var Sv,
        ...
        Lv = function (e) {
            ...
            return (
                t === r && Bo.isText(t)
                    ? 0 < n && n < t.nodeValue.length && ((t = (r = Pv(t, n)).previousSibling), n < o ? ((t = r = Pv(r, (o -= n)).previousSibling), (o = r.nodeValue.length), (n = 0)) : (o = 0))
                    : (Bo.isText(t) && 0 < n && n < t.nodeValue.length && ((t = Pv(t, n)), (n = 0)), Bo.isText(r) && 0 < o && o < r.nodeValue.length && (o = (r = Pv(r, o).previousSibling).nodeValue.length)),
        ...
        zv = function (e) {
            ...
            return vr.setAll(t, { id: Mv, "data-mce-bogus": "1", "data-mce-type": "format-caret" }), e && ki.append(t, er.fromText(Iv)), t;
        },
        Vv = function (e, t, n, r) {
            var o, i, a, u;
            (o = t.getRng(!0)),
                ...
                Fv(n)
                    ...
                    : ((u = Uv(n)) && u.nodeValue.charAt(0) === Iv && u.deleteData(0, 1),
                      (a = u),
    ...
    var Jv = function (e, t) {
            ...
            return "none" !== n.remove
                ? ((d = e),
                  ...
                  g.block &&
                      (b
                          ? h === v.getRoot() &&
                            ((g.list_block && eb(m, g.list_block)) ||
                                Zv(Yt.grep(m.childNodes), function (e) {
                                    Cl.isValid(d, b, e.nodeName.toLowerCase()) ? (p ? p.appendChild(e) : ((p = rb(v, e, b)), v.setAttribs(p, d.settings.forced_root_block_attrs))) : (p = 0);
                                }))
                          : v.isBlock(m) && !v.isBlock(h) && (ob(v, m, !1) || ob(v, m.firstChild, !0, 1) || m.insertBefore(v.create("br"), m.firstChild), ob(v, m, !0) || ob(v, m.lastChild, !1, 1) || m.appendChild(v.create("br")))),
                  (g.selector && g.inline && !eb(g.inline, m)) || v.remove(m, 1),
                  !0)
                : void 0;
        },
        ab = ib,
        ub = function (s, c, l, e, f) {
            var t,
                ...
                o = function (e) {
                    var n,
                        ...
                        u =
                            ...
                            (o = l),
                            (i = f),
                            Zv(Cl.getParents(n.dom, t.parentNode).reverse(), function (e) {
                                var t;
                ...
                g = function (e) {
                    var t, n, r, o, i;
                    if ((Bo.isElement(e) && u.getContentEditable(e) && ((o = a), (a = "true" === u.getContentEditable(e)), (i = !0)), (t = Yt.grep(e.childNodes)), a && !i)) for (n = 0, r = d.length; n < r && !ib(s, d[n], l, e, e); n++);
                    if (m.deep && t.length) {
                    ...
                    if (((e = Bl(s, e, d, !0)), m.split)) {
                        if ((t = nb(s, e, !0)) !== (n = nb(s, e))) {
                            if (
                                ...
                                u.isChildOf(t, n) && t !== n && !u.isBlock(n) && !tb(t) && !tb(n))
                            )
                                return (t = rb(u, t, "span", { id: "_start", "data-mce-type": "bookmark" })), o(t), void (t = i(!0));
                        ...
                        Zv(e, function (e) {
                            g(e),
                                Bo.isElement(e) &&
                                    ...
                                    e.parentNode &&
                                    "underline" === Cl.getTextDecoration(u, e.parentNode) &&
                                    ib(s, { deep: !1, exact: !0, inline: "span", styles: { textDecoration: "underline" } }, null, e);
                        });
                    });
                };
            if (e) e.nodeType ? ((n = u.createRng()).setStartBefore(e), n.setEndAfter(e), p(n)) : p(e);
                ...
                r.isCollapsed() && m.inline && !u.select("td[data-mce-selected],th[data-mce-selected]").length
                    ...
                    : ((t = Xu.getPersistentBookmark(s.selection, !0)), p(r.getRng()), r.moveToBookmark(t), m.inline && Ov.match(s, c, l, r.getStart()) && Cl.moveStart(u, r, r.getRng()), s.nodeChanged());
            else {
                e = r.getNode();
        ...
        hb = function (e, t) {
            ...
            1 === t.nodeType &&
                ...
                ((n = Cl.getTextDecoration(e, t.parentNode)), e.getStyle(t, "color") && n ? e.setStyle(t, "text-decoration", n) : e.getStyle(t, "text-decoration") === n && e.setStyle(t, "text-decoration", null));
        },
        vb = function (n, e, r, o) {
            sb(e, function (t) {
        ...
        wb = function (t, n, r, o, i) {
            (Ov.matchNode(t, i.parentNode, r, o) && ab(t, n, o, i)) ||
                            ...
                            var a,
                                u = function (e) {
                                    ...
                                    if (b.wrapper && Ov.matchNode(g, e, p, h)) a = 0;
                                        ...
                                        !m || r || !Cl.isValid(g, l, t) || !Cl.isValid(g, n, l) || (!c && 3 === e.nodeType && 1 === e.nodeValue.length && 65279 === e.nodeValue.charCodeAt(0)) || Gu(e) || (b.inline && s.isBlock(e))
                                            ? ((a = 0), Nb(Yt.grep(e.childNodes), u), r && (m = o), (a = 0))
                        ...
                        Nb(d, function (e) {
                            ...
                            (n = 0),
                                ...
                                (!(1 < d.length) && s.isBlock(e)) || 0 !== t
                                    ? (b.inline || b.wrapper) &&
                                      (b.exact || 1 !== t || ((o = a((r = e))) && !hl(o) && Ov.matchName(s, o, b) && ((i = s.clone(o, !1)), y(i), s.replace(i, r, !0), s.remove(o, 1)), (e = i || r)),
                                      vb(g, v, h, e),
                                      wb(g, b, p, h, e),
                                      yb(s, b, h, e),
                                      Cb(s, b, h, e),
                    ...
                    if (r) r.nodeType ? C(v, r) || ((t = i.createRng()).setStartBefore(r), t.setEndAfter(r), a(i, Bl(g, t, v), 0, !0)) : a(i, r, 0, !0);
                        ...
                        !(function (e, t, n) {
                            ...
                            s && 0 < a && a < s.length && d.test(s.charAt(a)) && d.test(s.charAt(a - 1))
                                ? ((u = c.getBookmark()), r.collapse(!0), (r = Bl(e, r, e.formatter.get(t))), (r = Lv(r)), e.formatter.apply(t, n, r), c.moveToBookmark(u))
                                : ((o && i.nodeValue === Iv) || ((l = e.getDoc()), (f = zv(!0).dom()), (i = (o = l.importNode(f, !0)).firstChild), r.insertNode(o), (a = 1)), e.formatter.apply(t, n, o), c.setCursorLocation(i, a));
                        })(g, p, h);
                    else {
                            ...
                            Tb(r, function (t) {
                                return a.formatter.matchNode(t, n, {}, e.similar)
                                    ? (u[n] ||
                                      ...
                                      (o[n] = e),
                                      !1)
                                    : !Ov.matchesUnInheritedFormatSelector(a, t, n) && void 0;
                            });
                        }),
                        Tb(u, function (e, t) {
                            o[t] ||
        ...
        Db = function (e, t) {
            var n,
                ...
                g = function (e) {
                    var t, n, r;
                    return (o = "string" == typeof e ? { name: e, classes: [], attrs: {} } : e), (t = Rb.create(o.name)), (n = t), (r = o).classes.length && Rb.addClass(n, r.classes.join(" ")), Rb.setAttribs(n, r.attrs), t;
                },
                p = function (n, e, t) {
                    var r,
                        o,
                    ...
                    return (
                        ...
                        t &&
                            (r || (r = Rb.create("div")).appendChild(n),
        ...
        Pb = function (n, e) {
            ...
            return "preview" in e && !1 === (u = e.preview)
                ...
                : ((t = e.block || e.inline || "span"),
                  (i = Ob(e.selector)).length ? (i[0].name || (i[0].name = t), (t = e.selector), (r = Db(i, n))) : (r = Db([t], n)),
                  (o = Rb.select(t, r)[0] || r.firstChild),
                  ...
                  Rb.setStyles(r, { position: "absolute", left: -65535 }),
                  n.getBody().appendChild(r),
                  (a = Rb.getStyle(n.getBody(), "fontSize", !0)),
                  (a = /px$/.test(a) ? parseInt(a, 10) : 0),
                  _b(u.split(" "), function (e) {
                      var t = Rb.getStyle(o, e, !0);
                      if (
                          !(
                              ("background-color" === e && /transparent|rgba\s*\([^)]+,\s*0\)/.test(t) && ((t = Rb.getStyle(n.getBody(), e, !0)), "#ffffff" === Rb.toHex(t).toLowerCase())) ||
                              ("color" === e && "#000000" === Rb.toHex(t).toLowerCase())
                          )
                      ) {
    ...
    var uy = function (e, t, n) {
        ...
        ly = function (e, t, n, r, o) {
            var i,
                ...
                u,
                s,
                c = ((i = r), of(t, n).serialize(i));
            return (a = e), (s = c), !(u = o).no_events && a ? Yg(a, zb(u, { content: s })).content : s;
        };
    function fy(e, t) {
        var a,
            u,
    ...
    function dy(e) {
        return { getBookmark: b(gl, e), moveToBookmark: b(pl, e) };
    }
    ...
    var my = dy,
            ...
            var R = function (e) {
                ...
                O = function (e) {
                    ...
                    (t = e.screenX - d),
                        ...
                        (y = y < 5 ? 5 : y),
                        (C = C < 5 ? 5 : C),
                        (R(u) && !1 !== a.settings.resize_img_proportional ? !Wh.modifierPressed(e) : Wh.modifierPressed(e) || (R(u) && f[2] * f[3] != 0)) &&
                        ...
                        (t = _.scrollWidth - x) + (n = _.scrollHeight - w) != 0 && N.setStyles(c, { left: r - t, top: o - n }),
                        i || (Qg(a, u, h, v), (i = !0));
                },
                P = function () {
                    i = !1;
                        ...
                        B(e) && !n.isDefaultPrevented()
                            ? E(l, function (n, e) {
                                  ...
                                  (t = N.get("mceResizeHandle" + e)) && N.remove(t),
                                      (t = N.add(_, "div", { id: "mceResizeHandle" + e, "data-mce-bogus": "all", class: "mce-resizehandle", unselectable: !0, style: "cursor:" + e + "-resize; margin:0; padding:0" })),
                                      ...
                                      N.bind(t, "mousedown", function (e) {
                                          ...
                                          e.stopImmediatePropagation(),
                                              ...
                                              (c = N.add(_, "div", { class: "mce-resize-helper", "data-mce-bogus": "all" }, h + " &times; " + v));
                                      }),
                                      (n.elm = t),
                ...
                I = function (e) {
                    ...
                    i ||
                        ...
                        n((t = N.$(t).closest("table,img,figure.image,hr")[0]), _) && (U(), n(r.getStart(!0), t) && n(r.getEnd(!0), t)) ? o(t) : L());
                },
                M = function (e) {
                    return gy(
                        (function (e, t) {
        ...
        Ly = function (e, o) {
            return ((t = e), (n = o[0]), na(n, "table", b(Ur.eq, t)))
                .bind(function (e) {
                    var t = o[0],
                        n = o[o.length - 1],
                        r = Ay(e);
        ...
        My = function (e, t) {
            ...
            r.cloneContents
                ? (n = t.contextual ? Iy(er.fromDom(e.getBody()), a).dom() : r.cloneContents()) && o.appendChild(n)
        ...
        Wy = function (u, s, e, c) {
            var n,
                ...
                m = function () {
                    ...
                    return (
                        (t = yy(c, [t])[0]) || (t = r.createRange ? r.createRange() : r.body.createTextRange()),
                        ...
                        return (
                            ...
                            (t = m())
                                ? ((r = t.startContainer),
                                  ...
                                  3 === r.nodeType && 3 === o.nodeType && ((r = r.length === i ? qy(r.nextSibling, !0) : r.parentNode), (o = 0 === a ? qy(o.previousSibling, !1) : o.parentNode), r && r === o))
                                      ? r
                                      : n && 3 === n.nodeType
                                      ? n.parentNode
                                      : n)
                    ...
                    getSelectedBlocks: function (e, t) {
                        return (function (e, t, n, r) {
                            ...
                            if (((i = e.getRoot()), (n = e.getParent(n || zy(i, t, !1), e.isBlock)), (r = e.getParent(r || Vy(i, t, !1), e.isBlock)), n && n !== i && a.push(n), n && r && n !== r))
                                for (var u = new io((o = n), i); (o = u.next()) && o !== r; ) e.isBlock(o) && a.push(o);
        ...
        Qy = function (e, t, n, r) {
            var o,
                ...
                l = e === Tu.Forwards,
                f = l ? Gy : Yy;
            return !r.collapsed && ((o = Xy(r)), Ky(o))
                ? ls(e, t, o, e === Tu.Backwards, !0)
                : ((u = _a(r.startContainer)),
                  f((i = Yc(e, t.getBody(), r)))
                      ? fs(t, i.getNode(!l))
                      : (i = n(i))
                      ? f(i)
                          ? ls(e, t, i.getNode(!l), l, !0)
                          : f((a = n(i))) && ((!(c = Uc((s = i), a)) && Bo.isBr(s.getNode())) || c)
                          ? ls(e, t, a.getNode(!l), l, !0)
                          : u
                          ? ms(t, i.toRange(), !0)
                          : null
                      : u
        ...
        Zy = function (e, t, n, r) {
            ...
            if (((d = Xy(r)), (o = Yc(e, t.getBody(), r)), (i = n(t.getBody(), Ph(1), o)), (a = jt.filter(i, Lh(1))), (s = jt.last(o.getClientRects())), (Gy(o) || Qc(o)) && (d = o.getNode()), (Yy(o) || Zc(o)) && (d = o.getNode(!0)), !s))
                return null;
        ...
        eC = function (e, t, n) {
            ...
            if (n.collapsed && e.settings.forced_root_block) {
                ...
                (1 === t ? s(Au.fromRangeStart(n)) : c(Au.fromRangeStart(n))) ||
            ...
            return function () {
                var e,
                    ...
                    c =
                        ((t = f),
                        (r = Ts((e = l).getBody())),
                        (o = wa.curry(Jy, r.next)),
                        (i = wa.curry(Jy, r.prev)),
                        (a = t ? Tu.Forwards : Tu.Backwards),
                        (u = t ? o : i),
                        (s = e.selection.getRng()),
                        (n = Qy(a, e, u, s)) ? n : (n = eC(e, a, s)) || null);
        ...
        nC = function (u, s) {
            return function () {
                var e,
                    ...
                    o,
                    i,
                    a = ((r = (t = s) ? 1 : -1), (o = t ? Oh : Bh), (i = (e = u).selection.getRng()), (n = Zy(r, e, o, i)) ? n : (n = eC(e, r, i)) || null);
        ...
        rC = function (e, r) {
            return G(
                $(e, function (e) {
                    return zb({ shiftKey: !1, altKey: !1, ctrlKey: !1, metaKey: !1, keyCode: 0, action: v }, e);
                }),
                function (e) {
        ...
        aC = function (i, a) {
            i.on("keydown", function (e) {
                ...
                !1 === e.isDefaultPrevented() &&
                    ...
                    iC(
                        [
                            { keyCode: Wh.RIGHT, action: tC(t, !0) },
                            { keyCode: Wh.LEFT, action: tC(t, !1) },
                            { keyCode: Wh.UP, action: nC(t, !1) },
                            { keyCode: Wh.DOWN, action: nC(t, !0) },
                            { keyCode: Wh.RIGHT, action: xc(t, !0) },
                            { keyCode: Wh.LEFT, action: xc(t, !1) },
                            { keyCode: Wh.UP, action: wc(t, !1) },
                            { keyCode: Wh.DOWN, action: wc(t, !0) },
                            { keyCode: Wh.RIGHT, action: um.move(t, n, !0) },
                            { keyCode: Wh.LEFT, action: um.move(t, n, !1) },
                            { keyCode: Wh.RIGHT, ctrlKey: !o.isOSX(), altKey: o.isOSX(), action: um.moveNextWord(t, n) },
                            { keyCode: Wh.LEFT, ctrlKey: !o.isOSX(), altKey: o.isOSX(), action: um.movePrevWord(t, n) },
                        ],
                        r
                    ).each(function (e) {
                        r.preventDefault();
        ...
        fC = function (o, i) {
            o.on("keydown", function (e) {
                ...
                !1 === e.isDefaultPrevented() &&
                    ...
                    iC(
                        [
                            { keyCode: Wh.BACKSPACE, action: oC(yd, t, !1) },
                            { keyCode: Wh.DELETE, action: oC(yd, t, !0) },
                            { keyCode: Wh.BACKSPACE, action: oC(fm, t, n, !1) },
                            { keyCode: Wh.DELETE, action: oC(fm, t, n, !0) },
                            { keyCode: Wh.BACKSPACE, action: oC(jm, t, !1) },
                            { keyCode: Wh.DELETE, action: oC(jm, t, !0) },
                            { keyCode: Wh.BACKSPACE, action: oC(td, t, !1) },
                            { keyCode: Wh.DELETE, action: oC(td, t, !0) },
                            { keyCode: Wh.BACKSPACE, action: oC(Jf, t, !1) },
                            { keyCode: Wh.DELETE, action: oC(Jf, t, !0) },
                            { keyCode: Wh.BACKSPACE, action: oC(lC, t, !1) },
                            { keyCode: Wh.DELETE, action: oC(lC, t, !0) },
                        ],
                        r
                    ).each(function (e) {
                        r.preventDefault();
                ...
                o.on("keyup", function (e) {
                    ...
                    !1 === e.isDefaultPrevented() &&
                        ...
                        iC(
                            [
                                { keyCode: Wh.BACKSPACE, action: oC(Cd, t) },
                                { keyCode: Wh.DELETE, action: oC(Cd, t) },
                            ],
                            n
                        ));
                });
                ...
                (u = kC(C, s)) &&
                        ...
                        (s = (function (e, t, n, r, o) {
                            ...
                            if (!(a = m.getParent(r, m.isBlock)) || !SC(m, a)) {
                                if (((l = (a = a || g) === e.getBody() || ((f = a) && /^(TD|TH|CAPTION)$/.test(f.nodeName)) ? a.nodeName.toLowerCase() : a.parentNode.nodeName.toLowerCase()), !a.hasChildNodes()))
                                    return (i = m.create(d)), AC(e, i), a.appendChild(i), n.setStart(i, 0), n.setEnd(i, 0), i;
                    ...
                    /^(LI|DT|DD)$/.test(f) && C.isEmpty(c)
                        ...
                        : (m && c === a.getBody()) ||
                          ((m = m || "P"),
                          _a(c)
                              ? ((r = Fa(c)), C.isEmpty(c) && NC(c), mC(a, r))
                              : S()
                              ? T()
                              : S(!0)
                              ? ((r = c.parentNode.insertBefore(E(), c)), mC(a, EC(c, "HR") ? r : c))
                              : ((t = ((b = N), (y = b.cloneRange()), y.setStart(b.startContainer, TC(!0, b.startContainer, b.startOffset)), y.setEnd(b.endContainer, TC(!1, b.endContainer, b.endOffset)), y).cloneRange()).setEndAfter(c),
                                (function (e) {
                                    ...
                                    if (o) {
                                        ...
                                        for (r = i.length; r--; )
                                            !(o = i[r]).hasChildNodes() || (o.firstChild === o.lastChild && "" === o.firstChild.nodeValue)
                                                ? e.remove(o)
                                                : (a = o) && "A" === a.nodeName && 0 === Yt.trim(Ta(a.innerText || a.textContent)).length && e.remove(o);
                                        var a;
                                    }
                                })(C, w, r),
                                (p = C),
                                ...
                                C.isEmpty(c) && NC(c),
                                r.normalize(),
                                C.isEmpty(r) ? (C.remove(r), T()) : mC(a, r)),
                          C.setAttrib(r, "id", ""),
        ...
        jC = function (e, t) {
            return Dd(
                [
                    HC([PC], OC.none()),
                    HC([MC("summary", !0)], OC.br()),
                    HC([FC(!0), UC(!1), VC], OC.br()),
                    HC([FC(!0), UC(!1)], OC.block()),
                    HC([FC(!0), UC(!0), VC], OC.block()),
                    HC([FC(!0), UC(!0)], OC.br()),
                    HC([IC(!0), VC], OC.br()),
                    HC([IC(!0)], OC.block()),
                    HC([LC(!0), VC, qC], OC.block()),
                    HC([LC(!0)], OC.br()),
                    HC([zC], OC.br()),
                    HC([LC(!1), VC], OC.br()),
                    HC([qC], OC.block()),
        ...
        GC = function (r) {
            r.on("keydown", function (e) {
                ...
                !1 === e.isDefaultPrevented() &&
                    ((t = r),
                    (n = e),
                    iC([{ keyCode: Wh.SPACEBAR, action: oC(YC, t) }], n).each(function (e) {
                        n.preventDefault();
                    }));
            });
        },
        ...
        QC = function (e, t) {
            var n,
                r =
                    ((n = e),
                    ra(er.fromDom(n.getBody()), "*[data-mce-caret]").fold(H(null), function (e) {
                        return e.dom();
                    }));
    ...
    var nx = function (e) {
                ...
                3 === e.detail &&
                    (function (e) {
                        ...
                        if (Su.isElementPosition(n)) {
                            var o = n.container();
                            nx(o) &&
                                al.firstPositionIn(o).each(function (e) {
                        ...
                        Su.isElementPosition(r) &&
                            ((o = n.container()),
                            nx(o) &&
                                al.lastPositionIn(o).each(function (e) {
        ...
        ux = function (t, e) {
            ...
            m.inline || (t.getElement().style.visibility = t.orgVisibility),
                ...
                m.content_editable &&
                    ...
                    ix.addClass(g, "mce-content-body"),
                    (t.contentDocument = p = m.content_document || document),
                    (t.contentWindow = m.content_window || window),
                    (t.bodyElement = g),
                    (m.content_document = m.content_window = null),
                    (m.root_name = g.nodeName.toLowerCase())),
                ...
                (t.parser =
                    ((o = ay((u = t).settings, u.schema)).addAttributeFilter("src,href,style,tabindex", function (e, t) {
                ...
                0 < t.contentStyles.length &&
                    ...
                    t.dom.addStyle(r)),
                ((s = t), s.inline ? ix.styleSheetLoader : s.dom.styleSheetLoader).loadAll(
                    t.contentCSS,
                    function (e) {
                        ax(t);
                    },
        ...
        cx = function (e, t) {
            var n,
                ...
                (s = er.fromTag("iframe")),
                vr.setAll(s, i),
                vr.setAll(s, { id: n + "_ifr", frameBorder: "0", allowTransparency: "true", title: r }),
                Sr(s, { width: "100%", height: ((a = o), (u = "number" == typeof a ? a + "px" : a), u || ""), display: "block" }),
                s).dom();
            l.onload = function () {
            ...
            return (
                ...
                (e.iframeHTML =
                    ((g = Js((f = e)) + "<html><head>"),
                    Qs(f) !== f.documentBaseUrl && (g += '<base href="' + f.documentBaseURI.getURI() + '" />'),
                    (g += '<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />'),
                    (d = Zs(f)),
                    (m = ec(f)),
                    tc(f) && (g += '<meta http-equiv="Content-Security-Policy" content="' + tc(f) + '" />'),
        ...
        dx = function (t, n, e) {
            ...
            if (((r = Hp.urls[e] || t.documentBaseUrl.replace(/\/$/, "")), (e = Yt.trim(e)), i && -1 === Yt.inArray(n, e))) {
                if (
                    (Yt.each(Hp.dependencies(e), function (e) {
                        dx(t, n, e);
                    }),
                    t.plugins[e])
                )
        ...
        hx = function (e) {
            ...
            return (
                ...
                k(d.theme)
                    ? ((l = (o = e).settings),
                      (f = o.getElement()),
                      (i = l.width || fx.getStyle(f, "width") || "100%"),
                      (a = l.height || fx.getStyle(f, "height") || f.offsetHeight),
                      (u = l.min_height || 100),
        ...
        xx = function (t) {
            ...
            if (je.Event.domLoaded) {
                if (t.getElement() && Re.contentEditable) {
                    ...
                    o &&
                        ((t.formElement = o),
                        e.hidden_input && !/TEXTAREA|INPUT/i.test(t.getElement().nodeName) && (bx.insertAfter(bx.create("input", { type: "hidden", name: n }), n), (t.hasHiddenInput = !0)),
                        (t.formEventDelegate = function (e) {
                            t.fire(e.type, e);
                        }),
                        bx.bind(o, "submit reset", t.formEventDelegate),
                        t.on("reset", function () {
        ...
        kx = function (r, e) {
            ...
            if (((r = Ex(r)), (t = (e = o.settings = e || {}).base_uri), /^([\w\-]+):([^\/]{2})/i.test(r) || /^\s*#/.test(r))) o.source = r;
                ...
                0 !== r.indexOf("/") || i || (r = ((t && t.protocol) || "http") + "://mce_host" + r),
                    /^[\w\-]*:?\/\//.test(r) ||
                        ((n = e.base_uri ? e.base_uri.path : new kx(document.location.href).directory),
    ...
    (kx.prototype = {
        ...
        toAbsolute: function (e, t) {
            return (e = new kx(e, { base_uri: this })).getURI(t && this.isSameOrigin(e));
        },
    ...
    var Ax = function (e, t, n) {
        ...
        Bx = function (e, t) {
            ...
            e.dom.setHTML(e.getBody(), t),
                Ep((r = e)) &&
                    al.firstPositionIn(r.getBody()).each(function (e) {
                        var t = e.getNode(),
                        ...
                        : ((t = u),
                          ...
                          0 === (r = s).length || /^\s+$/.test(r)
                              ? ((a = '<br data-mce-bogus="1">'),
                                ...
                                (i = rc(t)) && t.schema.isValidChild(n.nodeName.toLowerCase(), i.toLowerCase()) ? ((r = a), (r = t.dom.createHTML(i, t.settings.forced_root_block_attrs, r))) : r || (r = '<br data-mce-bogus="1">'),
                                Bx(t, r),
                                t.fire("SetContent", o))
                              : ("raw" !== o.format && (r = of({ validate: t.validate }, t.schema).serialize(t.parser.parse(r, { isRootContent: !0, insert: !0 }))),
                                (o.content = xo(er.fromDom(n)) ? r : Yt.trim(r)),
                                Bx(t, o.content),
        ...
        Mx = function (e, t) {
            ...
            e.destroyed ||
                (t || e.removed
                    ? (t || (e.editorManager.off("beforeunload", e._beforeUnload), e.theme && e.theme.destroy && e.theme.destroy(), Lx(i), Lx(a)),
                      (r = (n = e).formElement) && (r._mceOldSubmit && ((r.submit = r._mceOldSubmit), (r._mceOldSubmit = null)), Px.unbind(r, "submit reset", n.formEventDelegate)),
        ...
        Hx = function (e, t, n) {
            ...
            (r = l),
                ...
                l.setDirty(!1),
                (l.plugins = {}),
                (l.documentBaseURI = new kx(t.document_base_url, { base_uri: d })),
                (l.baseURI = d),
                (l.contentCSS = []),
                (l.contentStyles = []),
        ...
        (Hx.prototype = {
            ...
            execCallback: function (e) {
                ...
                if (o)
                    return (
                        ...
                        "string" == typeof o && ((r = (r = o.replace(/\.\w+$/, "")) ? Vx(r) : 0), (o = Vx(o)), (this.callbackLookup = this.callbackLookup || {}), (this.callbackLookup[e] = { func: o, scope: r })),
            ...
            addContextToolbar: function (e, t) {
                ...
                (r.contextToolbars = r.contextToolbars || []),
                    ...
                    r.contextToolbars.push({ id: ah.uuid("mcet"), predicate: e, items: t });
            },
            ...
            hide: function () {
                ...
                e.hidden ||
                    ...
                    e.save(),
                    e.inline ? ((e.getBody().contentEditable = !1), e === e.editorManager.focusedEditor && (e.editorManager.focusedEditor = null)) : (Fx.hide(e.getContainer()), Fx.setStyle(e.id, "display", e.orgDisplay)),
                    (e.hidden = !0),
                    e.fire("hide"));
            },
            isHidden: function () {
            ...
            getContent: function (e) {
                return (
                    (t = this),
                    void 0 === (n = e) && (n = {}),
                    A.from(t.getBody()).fold(H("tree" === n.format ? new Yb("body", 11) : ""), function (e) {
                        return Ax(t, n, e);
                    })
                );
                var t, n;
            ...
            addVisual: function (e) {
                ...
                (e = e || r.getBody()),
                    ...
                    zx(i.select("table,a", e), function (e) {
                        var t;
                        switch (e.nodeName) {
                            case "TABLE":
    ...
    var jx,
        ...
        Yx = function (e) {
            ...
            e.inline &&
                ...
                hi.DOM.bind(document, "mouseup", r),
                t.on("remove", function () {
        ...
        (Wx = {
            ...
            setup: function () {
                var e,
                    ...
                    o = "";
                if (
                    ((t = kx.getDocumentBaseUrl(document.location)),
                    /^[^:]+:\/\/\/?[^\/]+\//.test(t) && ((t = t.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, "")), /[\/\\]$/.test(t) || (t += "/")),
            ...
            add: function (e) {
                ...
                return (
                    fw[e.id] === e ||
                        (null === t.get(e.id) && ("length" !== e.id && (fw[e.id] = e), fw.push(e), dw.push(e)),
                        gw(!0),
                        (t.activeEditor = e),
    ...
    Bw.extend = yw = function (n) {
        ...
        n.Defaults && o.Defaults && (n.Defaults = Dw({}, o.Defaults, n.Defaults)),
        n))
        ...
        Uw = {
            send: function (e) {
                ...
                if (
                    ...
                    (e.async = !1 !== e.async),
                    (e.data = e.data || ""),
                    Uw.fire("beforeInitialize", { settings: e }),
                    (t = new $p()))
                ) {
                    if (
                        ...
                        (t = Uw.fire("beforeSend", { xhr: t, settings: e }).xhr).send(e.data),
                        !e.async)
                    )
                        return r();
                    setTimeout(r, 10);
        ...
        (Vw.prototype = {
            send: function (n) {
                ...
                ((n = zw(this.settings, n)).success = function (e, t) {
                    void 0 === (e = Mw.parse(e)) && (e = { error: "JSON Parse error." }), e.error ? r.call(n.error_scope || n.scope, e.error, t) : o.call(n.success_scope || n.scope, e.result);
                }),
                    (n.error = function (e, t) {
                        r && r.call(n.error_scope || n.scope, e, t);
                    }),
                    (n.data = Mw.serialize({ id: n.id || "c" + this.count++, method: n.method, params: n.params })),
                    (n.content_type = "application/json"),
                    Uw.send(n);
            },
        });
    var qw,
        Hw = window.localStorage,
        jw = vw,
        $w = {
            geom: { Rect: kw },
            util: {
                        ...
                        (n.toHsv = function () {
                            return (
                                ...
                                (i = Ow((e /= 255), Ow((t /= 255), (n /= 255)))) === (a = Pw(e, Pw(t, n)))
                                    ? { h: 0, s: 0, v: 100 * (o = i) }
                                    : ((r = (a - i) / a), { h: Lw(60 * ((e === i ? 3 : n === i ? 1 : 5) - (e === i ? t - n : n === i ? e - t : n - e) / ((o = a) - i))), s: Lw(100 * r), v: Lw(100 * o) })
                            );
                            var e, t, n, r, o, i, a;
                        }),
                        (n.toHex = function () {
