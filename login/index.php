...
function retrieve_password() {
	...
	$message .= '<' . network_site_url( APP_LOGIN . "/index.php?action=rp&key=$key&login=" . rawurlencode( $user_login ), 'login' ) . ">\r\n";
...
case 'retrievepassword' :
	...
	if ( $http_post ) {
		...
		if ( !is_wp_error($errors) ) {
			$redirect_to = !empty( $_REQUEST['redirect_to'] ) ? $_REQUEST['redirect_to'] : APP_LOGIN . '/index.php?checkemail=confirm';
			wp_safe_redirect( $redirect_to );
			exit();
		}
	}
...
<form name="lostpasswordform" id="lostpasswordform" action="<?php echo esc_url( network_site_url( APP_LOGIN . '/index.php?action=lostpassword', 'login_post' ) ); ?>" method="post">
	<p>
...
case 'rp' :
	...
	if ( ! $user || is_wp_error( $user ) ) {
		...
		if ( $user && $user->get_error_code() === 'expired_key' )
			wp_redirect( site_url( APP_LOGIN . '/index.php?action=lostpassword&error=expiredkey' ) );
		else
			wp_redirect( site_url( APP_LOGIN . '/index.php?action=lostpassword&error=invalidkey' ) );
		exit;
	}
...
?>
<form name="resetpassform" id="resetpassform" action="<?php echo esc_url( network_site_url( APP_LOGIN . '/index.php?action=resetpass', 'login_post' ) ); ?>" method="post" autocomplete="off">
...
case 'register' :
	...
	if ( !get_option('users_can_register') ) {
		wp_redirect( site_url( APP_LOGIN . '/index.php?registration=disabled' ) );
		exit();
	}
...
?>
<form name="registerform" id="registerform" action="<?php echo esc_url( site_url( APP_LOGIN . '/index.php?action=register', 'login_post' ) ); ?>" method="post" novalidate="novalidate">
	<p>
