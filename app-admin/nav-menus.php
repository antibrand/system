...
if ( ! $locations_screen ) {
	...
	$overview = apply_filters( 'help_menu_menus_overview', $overview );
	...
	$menu_management .= '<li>' . __( 'To edit an existing menu, <strong>choose a menu from the drop down and click Select</strong>' ) . '</li>';

	$menu_management .= '<li>' . __( 'If you haven&#8217;t yet created any menus, <strong>click the &#8217;create a new menu&#8217; link</strong> to get started' ) . '</li>';
	...
	$menu_management = apply_filters( 'help_menu_management', $menu_management );
	...
	$editing_menus .= '<li>' . __( 'Add one or several items at once by <strong>selecting the checkbox next to each item and clicking Add to Menu</strong>' ) . '</li>';
	...
	$editing_menus .= '<li>' . __( 'Delete a menu item by <strong>expanding it and clicking the Remove link</strong>' ) . '</li>';

	$editing_menus .= '</ul>';

	$editing_menus = apply_filters( 'help_editing_menus', $editing_menus );
...
// Locations Tab.
	...
	$locations_overview .= '<li>' . __( 'To add a new menu instead of assigning an existing one, <strong>click the &#8217;Use new menu&#8217; link</strong>. The new menu will be automatically assigned to that theme location' ) . '</li>';

	$locations_overview .= '</ul>';

	$locations_overview = apply_filters( 'help_nav_locations_overview', $locations_overview );
...
<div class="wrap">
	...
	<div id="menu-locations-wrap">
		...
		<form method="post" action="<?php echo esc_url( add_query_arg( array( 'action' => 'locations' ), admin_url( 'nav-menus.php' ) ) ); ?>">
			<table class="fixed" id="menu-locations-table">
				<thead>
				<tr>
			...
			<p class="button-controls app-clearfix"><?php submit_button( __( 'Save Changes' ), 'primary left', 'nav-menu-locations', false ); ?></p>
	...
	<div id="nav-menus-frame" class="app-clearfix">
			...
			<form id="update-nav-menu" method="post" enctype="multipart/form-data">
				<div class="menu-edit <?php if ( $add_new_screen ) echo 'blank-slate'; ?>">
					...
					<div id="nav-menu-header">
						<div class="major-publishing-actions app-clearfix">
					...
					<div id="post-body" class="app-post-body">
						<div id="post-body-content" class="app-clearfix">
							<?php if ( ! $add_new_screen ) : ?>
