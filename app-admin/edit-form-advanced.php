 ...
 * @since Previous 4.1.0 Added the `$post_type` parameter.
 *
 ...
 * and if that autosave is different than the post.
 */
...
if ( post_type_supports( $post_type, 'description' ) ) {
	// add_meta_box( 'postdescription', __( 'Description' ), 'post_description_meta_box', null, 'normal', 'core' );
}
...
/**
 * Allow the Discussion meta box to show up if the post type supports
 * comments or if comments are open.
 */
...
/**
 * Fires after all built-in meta boxes have been added,
 * contextually for the given post type.
 *
...
<div class="wrap">
	...
	?>>
		...
		<?php if ( 'draft' != get_post_status( $post ) ) {
			...
			<div id="post-body" class="app-post-body metabox-holder columns-<?php echo 1 == get_current_screen()->get_columns() ? '1' : '2'; ?>">
				<div id="post-body-content">
					...
					<div id="titlediv">
						<div id="titlewrap">
							 ...
							 * @param WP_Post $post Post object.
							 */
							$title_placeholder = apply_filters( 'enter_title_here', __( 'Add Title Here' ), $post );
							?>
				...
				<div id="postbox-container-1" class="postbox-container">
					<?php if ( 'page' == $post_type ) {
						/**
						 * Fires before meta boxes with 'side' context are output for
						 * the 'page' post type.
						 *
