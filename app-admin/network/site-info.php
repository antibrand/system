...
if ( isset( $_REQUEST['action'] ) && 'update-site' == $_REQUEST['action'] ) {
	...
	if ( $is_main_site ) {
		 ...
		 * We first need to ensure a scheme has been provided,
		 * otherwise fallback to the existing.
		 */
...
<div class="wrap">
	...
	<form method="post" action="site-info.php?action=update-site">
		...
		<table class="form-table">
			...
			?>
			<tr>
				<th scope="row"><?php _e( 'Site Status' ); ?></th>
				<td>
				<fieldset>
					<legend class="screen-reader-text"><?php _e( 'Set site status' ) ?></legend>
