...
add_action( 'customize_controls_print_footer_scripts', 'app_footer_scripts' );
...
$body_class = 'app-core-ui wp-customizer js';
	...
	<div class="wp-full-overlay expanded">
		...
		<form id="customize-controls" class="wrap wp-full-overlay-sidebar">
			...
			<div id="customize-header-actions" class="wp-full-overlay-header">
				...
				<a class="button customize-controls-close" href="<?php echo esc_url( $wp_customize->get_return_url() ); ?>">
					...
					<div id="customize-info" class="accordion-section customize-info">
						<div class="accordion-section-title">
							<span class="preview-notice"><?php
								echo sprintf( __( 'You are managing %s' ), '<strong class="panel-title site-title">' . get_bloginfo( 'name', 'display' ) . '</strong>' );
							?></span>
