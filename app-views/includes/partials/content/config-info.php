...
?>
			<section id="config-info-database" class="form-step">
				...
				<p class="step hide-if-no-js"><a href="#config-intro" class="button prev"><?php _e( 'Previous' ); ?></a> <a href="#config-info-optional" class="button next"><?php _e( 'Next' ); ?></a></p>
			</section>
			...
			<section id="config-info-optional" class="form-step">
				...
				<p class="step hide-if-no-js"><a href="#config-info-database" class="button prev"><?php _e( 'Previous' ); ?></a> <a href="#config-identity" class="button next"><?php _e( 'Next' ); ?></a></p>
			</section>
