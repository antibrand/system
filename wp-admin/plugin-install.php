...
'title'   => __( 'Overview' ),
'content' =>
	'<p>' . sprintf( __( 'Plugins extend functionality with custom features. Plugins are developed independently from the application by thousands of developers all over the world.' ) ) . '</p>' .
...
// Get administration template header.
...
// Get administration template footer.
