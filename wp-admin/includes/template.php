...
require_once( ABSPATH . APPINC . '/classes/backend/class-wp-internal-pointers.php' );
...
<a href="#edit_timestamp" class="cancel-timestamp hide-if-no-js cancel-post-publish-action"><?php _e('Cancel'); ?></a>
</p>
<?php
}
 ...
 */
if ( isset($GLOBALS['body_id']) ) echo ' id="' . $GLOBALS['body_id'] . '"'; ?> class="wp-admin app-core-ui no-js iframe <?php echo $admin_body_classes . ' ' . $admin_body_class; ?>">
<script type="text/javascript">
(function(){
...
function convert_to_screen( $hook_name ) {
	...
	return AppNamespace\Backend\Screen::get( $hook_name );
}
