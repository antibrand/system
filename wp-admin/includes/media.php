...
<body<?php if ( isset($GLOBALS['body_id']) ) echo ' id="' . $GLOBALS['body_id'] . '"'; ?> class="app-core-ui no-js">
<script type="text/javascript">
...
function edit_form_image_editor( $post ) {
	...
	<div class="wp_attachment_holder app-clearfix">
	<?php
	...
	?>
		...
		<div<?php if ( $open ) echo ' style="display:none"'; ?> class="wp_attachment_image app-clearfix" id="media-head-<?php echo $attachment_id; ?>">
	...
	elseif ( isset( $thumb_url[0] ) ):
		...
		?>
		<div class="wp_attachment_image app-clearfix" id="media-head-<?php echo $attachment_id; ?>">
	...
	<div class="wp_attachment_details edit-form-section">
		<p>
			...
			<textarea name="excerpt" id="attachment_caption"><?php echo $post->post_excerpt; ?></textarea>
		</p>
	...
	<?php if ( 'image' === substr( $post->post_mime_type, 0, 5 ) ) : ?>
		<p>
			...
			<input type="text" name="_wp_attachment_image_alt" id="attachment_alt" value="<?php echo esc_attr( $alt_text ); ?>" />
		</p>
	<?php endif; ?>
...
?>
	<div class="misc-pub-section misc-pub-attachment">
		...
		<input type="text" class="urlfield" readonly="readonly" name="attachment_url" id="attachment_url" value="<?php echo esc_attr( $att_url ); ?>" />
	</div>
...
function wp_read_video_metadata( $file ) {
	...
	if ( ! class_exists( 'getID3', false ) ) {
		require( ABSPATH . APP_INC . '/ID3/getid3.php' );
	}
	$id3 = new getID3();
