...
function _wp_personal_data_export_page() {
	require_once( X_VIEWS_PATH . 'backend/content/data-export-personal.php' );
}
...
function _wp_personal_data_removal_page() {
	require_once( X_VIEWS_PATH . 'backend/content/data-remove-personal.php' );
}
...
function help_export_personal_data_overview() {
	...
	$html = require_once( X_VIEWS_PATH . 'backend/help/export-personal-data-overview.php' );
...
function help_export_personal_data_usage() {
	...
	$html = require_once( X_VIEWS_PATH . 'backend/help/export-personal-data-usage.php' );
...
function help_export_personal_data_download() {
	...
	$html = require_once( X_VIEWS_PATH . 'backend/help/export-personal-data-download.php' );
...
function help_remove_personal_data_overview() {
	...
	$html = require_once( X_VIEWS_PATH . 'backend/help/remove-personal-data-overview.php' );
