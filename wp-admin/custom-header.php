	...
	public function help() {
		get_current_screen()->add_help_tab( array(
			...
			'content' =>
				...
				'<p>' . __( 'You can choose from the theme&#8217;s default header images, or use one of your own. You can also customize how your Site Name and Description are displayed.') . '<p>'
		) );
		...
		get_current_screen()->add_help_tab( array(
			...
			'content' =>
				...
				'<p>' . __( 'If your theme has more than one default header image, or you have uploaded more than one custom header image, you have the option of displaying a random image on each page of your site. Click the &#8220;Random&#8221; radio button next to the Uploaded Images or Default Images section to enable this feature.') . '</p>' .
		...
		get_current_screen()->add_help_tab( array(
			...
			'content' =>
				'<p>' . sprintf( __( 'For most themes, the header text is your Site Name and Description, as defined in the <a href="%1$s">General Settings</a> section.' ), admin_url( 'options-general.php' ) ) . '<p>' .
...
<?php }
	...
	public function step_2() {
			...
			&& $width == get_theme_support( 'custom-header', 'width' ) && $height == get_theme_support( 'custom-header', 'height' ) )
		{
			...
			/** This filter is documented in APP_ADMIN_DIR/custom-header.php */
