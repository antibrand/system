...
get_current_screen()->add_help_tab( [
	'id'      => 'overview',
	'title'   => __( 'Overview' ),
	'content' => '<p>' . __( 'You can export a file of your site&#8217;s content in order to import it into another installation or platform. The export file will be an XML file format. Posts, pages, comments, custom fields, categories, and tags can be included. You can choose for the WXR file to include only certain posts or pages by setting the dropdown filters to limit the export by category, author, date range by month, or publishing status.' ) . '</p>' .
		'<p>' . __( 'Once generated, the file can be imported by a compatible site or by another blogging platform able to access this format.' ) . '</p>',
] );
 ...
 * @since 1.0.0
 */
$set_help_sidebar = apply_filters( 'set_help_sidebar_export', '' );
...
<div class="wrap">
	...
	<p><?php _e( 'When you click the button below an XML file will be created for you to save to your computer.' ); ?></p>

	<p><?php _e( 'This format will contain your posts, pages, comments, custom fields, categories, and tags.' ); ?></p>
