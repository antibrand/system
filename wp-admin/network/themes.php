...
/**
 * Clean up request URI from temporary args for
 * screen options/paging uri's to work as expected.
 */
		...
		case 'delete-selected' :
			...
			<div class="wrap">
				...
				<form method="post" action="<?php echo $referer ? esc_url( $referer ) : ''; ?>" style="display:inline;">
					<p><?php submit_button( __( 'No, return me to the theme list' ), '', 'submit', false ); ?></p>
				</form>
			</div>
			<?php
				require_once( ABSPATH . 'wp-admin/admin-footer.php' );
...
$help_overview = apply_filters( 'help_network_themes_overview', $help_overview );
 ...
 * @since 1.0.0
 */
$set_help_sidebar = apply_filters( 'set_help_sidebar_network_themes', '' );
...
<div class="wrap">
	...
	jQuery(document).ready( function($) {
		$( '#upload-theme-toggle' ).click( function() {
			...
			$( '#upload-network-theme' ).toggleClass( 'upload-theme-open' );
		});
