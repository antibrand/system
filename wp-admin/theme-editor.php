...
$help_overview .= sprintf(
	'<p id="editor-keyboard-trap-help-1">%1s</p>',
...
$help_overview .= sprintf(
	'<p>%1s</p>',
	__( 'Upgrading to a newer version of the same theme will override changes made here. To avoid this, consider creating a child theme.' )
);
...
$help_overview = apply_filters( 'help_theme_editor_overview', $help_overview );
 ...
 * @since 1.0.0
 */
$set_help_sidebar = apply_filters( 'set_help_sidebar_theme_editor', '' );
		...
		<div class="notification-dialog">
			<div class="file-editor-warning-content">
				<div class="file-editor-warning-message">
					...
					<p><?php _e( 'You appear to be making direct edits to your theme in the dashboard. We recommend that you don&#8217;t! Editing your theme directly could break your site and your changes may be lost in future updates. If you need to tweak more than your theme&#8217;s CSS, you might want to try making a child theme' ); ?></p>
