...
// Absolute path to the app's root directory, one level up from here.
if ( ! defined( 'ABSPATH' ) ) {
...
?>
	...
	<?php
	// Get the page footer.
	include_once( ABSPATH . 'wp-admin/partials/footer/config-install.php' );
			...
			<form class="setup-config-form" method="post" action="setup-config.php?step=2">
				<fieldset>
					...
					<p class="setup-config-field setup-config-app-tagline">
						...
						<br /><input name="app_tagline" id="app_tagline" type="text" size="25" value="" placeholder="<?php echo htmlspecialchars( _x( 'Your tagline here', 'example tagline for the website management system' ), ENT_QUOTES ); ?>" />
					</p>
					<p class="setup-config-field setup-config-app-website">
						<label for="app_website"><?php _e( 'Application Website' ); ?></label>
						<br /><input name="app_website" id="app_website" type="text" size="25" value="" placeholder="<?php echo esc_url( 'https://example.com/' ); ?>" />
					</p>
					<p class="setup-config-field setup-config-app-logo">
						<label for="app_logo"><?php _e( 'Application Logo' ); ?></label>
						<br /><input name="app_logo" id="app_logo" type="text" size="25" value="" placeholder="" />
					</p>
				</fieldset>
				<fieldset>
