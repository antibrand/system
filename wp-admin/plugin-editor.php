...
$help_overview = apply_filters( 'help_plugin_editor_overview', $help_overview );
 ...
 * @since 1.0.0
 */
$set_help_sidebar = apply_filters( 'set_help_sidebar_plugin_editor', '' );
		...
		<div class="notification-dialog">
			<div class="file-editor-warning-content">
				<div class="file-editor-warning-message">
					...
					<p><?php _e( 'You appear to be making direct edits to your plugin in the dashboard. We recommend that you don&#8217;t! Editing plugins directly may introduce incompatibilities that break your site and your changes may be lost in future updates.' ); ?></p>
