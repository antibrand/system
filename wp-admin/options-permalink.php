...
$help_overview = apply_filters( 'help_options_permalinks_overview', $help_overview );
...
$help_settings = apply_filters( 'help_options_permalinks_settings', $help_settings );

get_current_screen()->add_help_tab( [
	'id'      => 'permalink-settings',
	'title'   => __( 'Permalink Settings' ),
	'content' => $help_settings
] );

$help_structures = sprintf(
	'<h3>%1s</h3>',
...
$help_structures .= sprintf(
	'<p>%1s</p>',
	__( 'The Optional fields let you customize the &#8220;category&#8221; and &#8220;tag&#8221; base names that will appear in archive URLs. For example, the page listing all posts in the &#8220;General&#8221; category could be <code>/topics/uncategorized</code> instead of <code>/category/uncategorized</code>.' )
);
...
$help_structures = apply_filters( 'help_options_permalinks_structures', $help_structures );

get_current_screen()->add_help_tab( [
	'id'      => 'custom-structures',
	'title'   => __( 'Custom Structures' ),
	'content' => $help_structures
] );
 ...
 * @since 1.0.0
 */
$set_help_sidebar = apply_filters( 'set_help_sidebar_options_permalinks', '' );
