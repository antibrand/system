...
<?php endif; ?>
	...
	<div class="wrap" id="profile-page">
		...
		<?php endif; ?>
			...
			<?php endif; ?>
			<?php if ( user_can( $profileuser, 'edit_theme_options' ) || user_can( $profileuser, 'edit_plugins' ) || user_can( $profileuser, 'edit_themes' ) ) : ?>
			...
			<?php if ( $app_user_code_themes && count( $app_user_code_themes ) > 1 && has_action( 'user_code_theme_picker' ) ) :  ?>
				<?php if ( current_user_can( 'edit_files' ) || current_user_can( 'edit_css' ) ) : ?>
				...
				<tr class="show-admin-bar user-admin-bar-front-wrap">
					...
					<td>
						<fieldset>
							...
							<?php _e( 'Show Toolbar when viewing site' ); ?></label>
						</fieldset>
					</td>
				</tr>
