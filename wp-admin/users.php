...
if ( current_user_can( 'create_users' ) ) { ?>
	<a href="<?php echo admin_url( 'user-new.php' ); ?>" class="button page-title-action"><?php echo esc_html_x( 'Add New', 'user' ); ?></a>
<?php } elseif ( is_multisite() && current_user_can( 'promote_users' ) ) { ?>
	<a href="<?php echo admin_url( 'user-new.php' ); ?>" class="button page-title-action"><?php echo esc_html_x( 'Add Existing', 'user' ); ?></a>
<?php }
